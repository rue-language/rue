...
lean_package(
    ...
    trust = [
        ...
        "RueCore.freed_once",
        "RueCore.dtor_once",
        "RueCore.eval_conserves",
        "RueCore.dupProgram_step_double_free",
        "RueCore.drop_exactly_once",
        "RueCore.eval_exact",
        "RueCore.eval_quiet",
        "RueCore.pendingSafe_needed",
        ...
        "RueCore.reachable_drop_order",
        "RueCore.fieldsSwapped_rejected",
        "RueCore.returnPastAffine_newestFirst",
        "RueCore.unorderedRecord_rejected",
        "RueCore.Blocks.not_dtor",
        "RueCore.step_blocks",
        "RueCore.reachable_nested",
        "RueCore.step_nested",
        "RueCore.reachable_lifo",
        "RueCore.step_lifo",
        "RueCore.Lifo.newer",
        "RueCore.swappedMarkers_rejected",
        "RueCore.eval_sound",
        "RueCore.eval_sim",
        "RueCore.run_sim",
        ...
        "RueCore.checkDecls_sound",
        "RueCore.checkStructs_sound",
        "RueCore.checkEnums_sound",
        "RueCore.checkNoCycle_sound",
        "RueCore.checkArms_sound",
        "RueCore.class_unique",
        "RueCore.struct_class_unique",
        "RueCore.enum_class_unique",
        "RueCore.struct_carriesLinear_iff",
        "RueCore.enum_carriesLinear_iff",
        "RueCore.exhaustive_arm_exists",
        ...
        "RueCore.dropResidue_events",
        "RueCore.destructure_ok",
        "RueCore.valOf_inBounds",
        "RueCore.binOpInt_res",
        "RueCore.evalUnOp_int_res",
        "RueCore.evalIntCast_res",
        "RueCore.floatToInt_partition",
...
# no tier applies until the ADR's gate is met (RUE-2241). The corpus arrives
# as the Lean package's own output, so running it needs neither `lake` nor
# `elan` (ADR-0097 decision 1). Inputs are declared here and absolutized by
# the script, the way the cached corpus suites do it.
sh_binary(
...
# not define, cites a prose-specification paragraph docs/spec/src does not
# declare (RUE-2494), or the committed index is stale (`--write` regenerates
# it).
rue_sh_test(

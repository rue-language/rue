...
from gatelib.ci_api import LinearClient, Transport, TransportError, UrllibTransport
...
class LinearTracker(Tracker, LinearClient):
    ...
    def __init__(
        ...
        LinearClient.__init__(self, transport, api_key)

...
PUBLIC_TYPE_DECLARATION_ALLOWLIST = {
    ...
    ("rue-air", "semantic_type_resolution.rs", "ComptimeStructuredTypeRequest"): "borrowed structured-type reduction request view",
    ("rue-air", "semantic_type_resolution.rs", "ComptimeStructuredTypeAuthority"): "program-bound type-syntax authority, not a live type identity",

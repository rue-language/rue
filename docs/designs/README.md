...
| [0097](0097-mechanized-formal-core.md) | Mechanized formal core: a Lean 4 fourth view of the language, grown as a non-blocking experiment | Accepted | process, formal, testing, documentation |

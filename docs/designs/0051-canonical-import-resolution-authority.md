...
| `semantic_dependency_inputs` / ADR-0050 module edges | **Keep and tighten** | Continue consuming `CanonicalImportGraph`; invalid/non-closed graphs fail closed and no import rediscovery occurs. |

...
| `emit_load_slot`, `emit_store_slot`, `emit_load_ptr_base`, `emit_store_ptr_base`, `emit_load_through_ptr`, `emit_store_through_ptr`, `emit_frame_addr`, `emit_addr_add`, `emit_addr_add_imm`, `emit_scale_index_bytes`, `emit_scale` | yes | yes | target MIR memory/address forms and pointer arithmetic |

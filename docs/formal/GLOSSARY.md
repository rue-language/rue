...
[lean/MUTATION.md](lean/MUTATION.md), and the doc-comments of the mechanization's
...
|---|---|---|---|---|---|
| formal core; core; Core Rue; core calculus; calculus | The small, first-order, fully monomorphic language that surface Rue elaborates into, with its typing and reduction rules | [spec 1.3:1a][s1] | `Expr`, `Program` | Rue-specific, grounded | 01 intro; 03 intro; README intro; REDTEAM intro; lean/README intro; GUIDE intro; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
...
| prose specification; prose spec; spec; `X.Y:Z` | The human-facing Rue specification in `docs/spec/`, cited by paragraph id | [spec 1.3:1a][s1] | — | Rue-specific, grounded | 01 intro; README intro; REDTEAM “Roles”; lean/README “The bridge corpus”; GUIDE “How to read this guide”; BRIDGE-SENSITIVITY “Method”; MUTATION intro; `Float` |
...
| library; library obligations; library bug | The trusted standard-library code behind the buffer-backed containers, the conditions (§6.13.5) it must meet, and a violation of them | none | — | ours, pending audit | 01 §2; README “Contents”; lean/README “Deciding whether to believe it”; MUTATION “Limits” |
...
| MUST NOT; MUST | A requirement level: an absolute prohibition, an absolute requirement | [FIELD §7][F7]: RFC 2119 §§1–2; [spec 1.4:3][s1] | — | standard | 01 §2; 03 “Linear values are consumed exactly …”; README intro; REDTEAM “Roles”; lean/README “Generated programs”; GUIDE “Fuel, and why the theorems …”; BRIDGE-SENSITIVITY “Method”; MUTATION “Method”; `Float` |
...
| value; values; on values | A finished result of evaluation, which takes no step | [FIELD §1][F1]: PFPL §5.2 (`e val`) | `Val` | standard | 01 §2; 03 intro; README “Contents”; lean/README “The bridge corpus”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “Mutation score”; CHECKER-PROFILE intro; `Float` |
...
| integer; int(w, s); width; signedness; signed | The integer types, fixed by width in bits (8 to 64) and signedness | [spec 3.1:1][s3.1] | `IntWidth`, `Sign` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §4; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; `Float` |
| float; float(w) | The IEEE 754 binary32 and binary64 types, `f32` and `f64` | [spec 3.12:1][s3.12] | `FloatWidth` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION “What is mutated”; `Float` |
...
| never; never type | The type `!` of an expression that transfers control away and yields no value | [spec 3.4:1][s3.4] | — | Rue-specific, grounded | 01 §2; 03 intro; README “Relationship to the prose spec”; REDTEAM “Roles”; lean/README “The bridge corpus”; GUIDE intro; BRIDGE-SENSITIVITY “Results”; MUTATION “Method”; CHECKER-PROFILE intro; `Float` |
...
| active; active variant | The one variant an enum value holds at run time | [spec 6.3:20][s6.3] | — | Rue-specific, grounded | 01 §3; 03 intro; lean/README “The statement layer”; GUIDE “The three trace theorems, one …”; `Syntax` |
...
| array; arrays; array element; whole array | A fixed-length sequence of `n` elements of one type, `[T; n]` | [spec 3.5:1][s3.5] | `Ty.array` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
...
| step (of a path) | One field or index selection within a path | none | `Ty.fieldAt` | ours, pending audit | 01 §2; 03 intro; README “The architecture: surface → elaboration …”; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE “How to read this guide”; BRIDGE-SENSITIVITY “Rule coverage”; MUTATION “What is mutated”; `Float` |
...
| join; `⊔` | The least upper bound of two classes, the more restrictive of the two | [FIELD §9][F9]: Tarski 1955 §1 (least upper bound, join); [FIELD §4][F4]: Tov & Pucella (`⊔`) | `Mult.join` | standard | 01 §3; 03 intro; lean/README “Generated programs”; GUIDE §3; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION intro; CHECKER-PROFILE intro; `Float` |
...
| path; paths | The route from a place's root binding to it, as a list of field and index steps | [FIELD §5][F5]: Polonius (path); rustc-dev-guide (move path) | `Place.path` | standard | 01 §4.2; 03 intro; README intro; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “The mutants”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
| root; root binding | The local binding a place starts from | [spec 6.1:43][s6.1] ("a place rooted at") | `Place.root` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Building”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “Reading a proof failure”; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
...
| use; used | An occurrence of a place in value context; it copies a `Copy` value and moves any other | [spec 3.8:76][s3.8] | `Typed.useCopy`, `Typed.useMove` | Rue-specific, grounded | 01 intro; 03 intro; README intro; REDTEAM intro; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
...
| copies; copy | A use that duplicates a `Copy` value and leaves its place as it was | [spec 3.8:1][s3.8] | — | Rue-specific, grounded | 01 §2; 03 intro; README “The extension rubric”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY intro; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| statics; static; statically; static semantics; typing | The type system: the rules that decide which programs are well-formed | [FIELD §1][F1]: PFPL chs. 4–5 (statics / dynamics) | `Typed` | standard | 01 §2; 03 intro; README intro; lean/README “The bridge corpus”; GUIDE §1; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
...
| scope exit; scope | The end of a binding's scope, where it is dropped or checked | [spec 3.9:18][s3.9] | — | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
...
| stuck; stuck configuration | Not terminal, and no rule applies | [FIELD §1][F1]: PFPL ch. 6; Plotkin §3.1 Def. 11 | `Config.Stuck` | standard | 01 §6.1; 03 intro; lean/README “Generated programs”; GUIDE §2; MUTATION “What is mutated”; `Float` |
| stuck (the interpreter's refusal); monitored stuck | `eval`'s named refusal of a step, including the four checks §6 does not have | [FIELD §1][F1]: `EvalRes.stuck` differs, partial | `EvalRes`, `Violation` | ours, pending audit | 01 §6.1; 03 intro; lean/README “Generated programs”; GUIDE §2; MUTATION “What is mutated”; `Float` |
...
| hole (of a context); `[·]`; `□` | The empty position in an evaluation context | [FIELD §1][F1]: Felleisen & Hieb; PFPL | — | standard | 01 §4.2; 03 “No use-after-move”; REDTEAM “Targets”; lean/README “What is mechanized”; GUIDE §1; MUTATION “The mutants”; `Syntax` |
...
| environment; `ρ` | The map from each binding in scope to its cell and path | [FIELD §3][F3]: environment (Amin & Rompf §§2.1–2.2); `eval n ρ e` | `Env` | standard | 01 §2; 03 “Type safety”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Multi-function programs”; MUTATION “Method”; `Syntax` |
...
| hole (a moved-out cell); `⊘` | The contents of an uninitialized or moved-out cell | [FIELD §5][F5]: "hole" differs, partial; accepted: moved from, deinitialized, dead | `Contents.hole` | ours, pending audit | 01 §4.2; 03 intro; REDTEAM “Targets”; lean/README “What is mechanized”; GUIDE §1; MUTATION “The mutants”; `Syntax` |
...
| run | A whole evaluation of a program from its initial configuration | [FIELD §6][F6]: run (Leucker & Schallhart) | `run` | standard | 01 §1; 03 intro; README intro; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE intro; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE intro; `Float` |
...
| shell | What remains of a matched enum value after its payload is moved out | none | `matchConsume` | ours, pending audit | 03 “No double-free”; lean/README “The statement layer”; GUIDE §2; MUTATION “The mutants”; `Dynamics` |
...
| owned (node); own | Of an aggregate in a store: a non-`Copy` node whose identity the store owns | [FIELD §5][F5]: owner (Rust Book §4.1), partial | `Contents.own`, `storeOwn` | ours, pending audit | 01 §2; 03 intro; README “Why comptime is elaboration, not …”; REDTEAM intro; lean/README “The bridge corpus”; GUIDE intro; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE intro; `Float` |
...
| exact; rounded (operation) | An operation whose result needs no rounding, and one whose result is `rnd_w` of an exact value | [spec 3.12:36][s3.12] ("each result is exact") | `FloatOps` | Rue-specific, grounded | 01 §5; 03 “No use-after-drop / no leak …”; README intro; REDTEAM “The log”; lean/README “Deciding whether to believe it”; GUIDE §3; BRIDGE-SENSITIVITY “Observable destructors”; MUTATION “What is mutated”; `Float` |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| theorem; theorems; proved; proved about | A statement with a kernel-checked proof | [FIELD §8][F8]: `theorem` vs `def` (Reference §7.4) | — | standard | 01 §2; 03 intro; README intro; REDTEAM intro; lean/README intro; GUIDE intro; MUTATION intro; CHECKER-PROFILE intro; `Float` |
| statement; statements | What a theorem asserts, read apart from its proof | none; FIELD §8: a theorem's type is a `Prop` (Reference §7.4) ([FIELD §8][F8]) | — | ours, pending audit | 01 §2; 03 “Type safety”; README intro; REDTEAM intro; lean/README intro; GUIDE “How to read this guide”; MUTATION intro; `Float` |
...
| semantic; syntactic | Of typing or soundness: stated by what a program does, or by the typing rules alone | [FIELD §2][F2]: Timany §§2, 4 | `Config.SafeAt` | standard | 01 §2; 03 intro; lean/README “The statement layer”; GUIDE “How to read this guide”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
...
| adequacy; adequate | The agreement of `eval` with §6's small-step reduction, in both directions | [FIELD §3][F3]: "adequacy" differs, partial (accepted: semantic equivalence, Amin & Rompf) | `eval_sound`, `eval_complete` | ours, pending audit | 01 §6; 03 intro; lean/README “The bridge corpus”; GUIDE §2; MUTATION “What is mutated”; `Dynamics` |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| verified | Of a compiler or validator: proved correct against a specification (Leroy); the docs never use this sense of the checker or the interpreter — the checker is proved sound only, and `eval` is proved adequate to §6's `Step` (`eval_sound`, `eval_complete`), not itself the specification. Where the docs use "verified", it means confirmed against the compiler, confirmed by hand, or kernel-checked | [FIELD §7][F7]: verified compiler, verified validator (Leroy CACM §2.2) | — | standard | 01 §2; 03 “Linear values are consumed exactly …”; lean/README “What is mechanized”; GUIDE §6; BRIDGE-SENSITIVITY “Results”; `Float` |
| kernel; kernel-checked | Lean's small type checker, which re-checks every proof | [FIELD §8][F8]: Reference §2 | — | standard | 03 intro; README intro; lean/README “Deciding whether to believe it”; GUIDE “The one edge no monitor …”; MUTATION intro; `Float` |
| axiom | A constant assumed without proof | [FIELD §8][F8]: Reference §8 | — | standard | 03 “Lemmas §7 owes, and the …”; REDTEAM “Targets”; lean/README “Deciding whether to believe it”; GUIDE “What the proof needs”; MUTATION “Method”; `Float` |
| `sorry` | A placeholder that closes any goal by the axiom `sorryAx` | [FIELD §8][F8]: Reference §8.4 | — | standard | REDTEAM “Targets”; lean/README intro; GUIDE §7; MUTATION “Method” |
...
| Lean Comparator; Comparator | A tool that checks proofs against a trusted file of statements, replaying them through the kernel, and checks the proved statements match | [FIELD §8][F8]: comparator | — | standard | REDTEAM “Targets”; lean/README “The statement layer” |
...
| module; `module` system | A Lean source file, and Lean's module system that controls what one exposes | [FIELD §8][F8]: Reference §§5.3–5.4 | — | standard | 01 §2; lean/README “The bridge corpus”; GUIDE §2; MUTATION “Method”; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
| L0 syntax; L1 definitions; L2 proofs; L3 tooling; layer | The four layers of the package, each importing only its own or lower ones | none | — | ours, pending audit | 01 §6.13.3; README “Why comptime is elaboration, not …”; REDTEAM intro; lean/README “Deciding whether to believe it”; GUIDE §6; MUTATION “What is mutated”; `Float` |
| statement layer; spine; Spec statements | The planned layer of headline statements apart from proofs; the chain of theorems the main claim rests on | none | — | ours, pending audit | REDTEAM intro; lean/README “Deciding whether to believe it”; GUIDE §6; MUTATION “What is mutated” |

...
| float; float(w) | The IEEE 754 binary32 and binary64 types, `f32` and `f64` | [spec 3.12:1][s3.12] | `FloatWidth` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION “What is mutated”; `Float` |
...
| scope exit; scope | The end of a binding's scope, where it is dropped or checked | [spec 3.9:18][s3.9] | — | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “What the proofs kill, and …”; `Syntax` |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| datum; same datum | An abstract IEEE 754 value (a finite number, an infinity, or a NaN with a sign), not a bit pattern | [spec 3.12:1][s3.12] (the values of the format) | `FloatDatum` | Rue-specific, grounded | 01 §2; 03 “Lemmas §7 owes, and the …”; lean/README “Deciding whether to believe it”; GUIDE “The run”; `Float` |
...
| unordered | Of two floats: neither is less than, equal to, or greater than the other, because one is a NaN | [spec 3.12:27][s3.12] | `FloatDatum.lt` | Rue-specific, grounded | 01 §6.4; 03 “Lemmas §7 owes, and the …”; lean/README “Sharpness counter-examples”; GUIDE “What the checker demands”; `Float` |
...
| float model; `FloatModel`; interface | The rounded float operations, given as parameters with the laws IEEE 754 guarantees, rather than defined | none | `FloatModel`, `FloatOps` | ours, pending audit | 01 §6.4; 03 “Type safety”; README intro; lean/README “Deciding whether to believe it”; GUIDE §4; MUTATION “What is mutated”; `Float` |
...
| claim; claim as a whole | Every headline statement together with the definitions they use, as the red team attacks them | none | — | ours, pending audit | 01 §2; 03 intro; README intro; REDTEAM intro; lean/README “Explaining a program”; GUIDE “One program, traced both ways”; MUTATION “Limits”; `Dynamics` |
...
| soundness (of `eval`); sound | Every value and panic `eval` answers, §6's reduction also reaches | [FIELD §3][F3]: one direction of semantic equivalence (Amin & Rompf); FIELD's "differs" row for `eval_sound` | `eval_sound` | ours, pending audit | 01 §3; 03 intro; README “Why comptime is elaboration, not …”; lean/README intro; GUIDE §2; MUTATION “What is mutated”; `Float` |
...
| adequacy; adequate | The agreement of `eval` with §6's small-step reduction, in both directions | [FIELD §3][F3]: "adequacy" differs, partial (accepted: semantic equivalence, Amin & Rompf) | `eval_sound`, `eval_complete` | ours, pending audit | 01 §6; 03 intro; lean/README “Layers”; GUIDE §2; MUTATION “What is mutated”; `Dynamics` |
...
| caught | Of a re-introduced historical compiler bug: some corpus case notices it | [FIELD §7][F7]: "caught" differs, partial (accepted: killed) | — | ours, pending audit | 01 §5; README “The executable oracle”; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE §7; BRIDGE-SENSITIVITY intro; MUTATION “Mutation score”; `Dynamics` |
...
| Lean Comparator; Comparator | A tool that checks proofs against a trusted file of statements, replaying them through the kernel, and checks the proved statements match | [FIELD §8][F8]: comparator | — | standard | REDTEAM “Targets”; lean/README “The statement layer”; MUTATION “What is mutated” |
...
| statement layer; spine; Spec statements | The planned layer of headline statements apart from proofs; the chain of theorems the main claim rests on | none | — | ours, pending audit | REDTEAM intro; lean/README “Deciding whether to believe it”; GUIDE §6; MUTATION “Method” |
...
| change | One lane's diff, what per-lane review attacks, as opposed to the whole claim | none | — | ours, pending audit | 01 §2; README “Relationship to the prose spec”; REDTEAM intro; lean/README “Explaining a program”; GUIDE “The program”; MUTATION intro; `Dynamics` |
...
| `FloatModel` | `Float` | The float operations together with the laws §7 needs of them (closure, totality), each true of IEEE 754 | ours, pending audit | 03 “Type safety”; README intro; lean/README “Deciding whether to believe it”; GUIDE “What the proof needs”; MUTATION “What is mutated”; `Float` |
...
| `InBounds` | `Syntax` | An integer lies in its type's range; arithmetic outside it traps rather than wraps (`3.1:6`) | Rue-specific, grounded (spec 3.1:6) | lean/README “Deciding whether to believe it”; MUTATION “The mutants”; `Float` |
...
| `DropGlue` | `Trace.Defs` | §6.11's drop written rule by rule, not through the machine: the events dropping some contents emits, its destructor first, then its fields in declaration order or its elements ascending | standard (FIELD §5: drop glue, rustc-dev-guide *Drop elaboration*) | lean/README “What is mechanized”; MUTATION “What the proofs kill, and …”; `Trace.Defs` |
...
| `GlueBlocks` | `Trace.Defs` | `Blocks` with each drop's events given by `DropGlue` rather than by `dropEvents`: §6.11's drop order as a grammar over traces, in §6.11's own terms | ours, pending audit | lean/README “Sharpness counter-examples”; MUTATION “What the proofs kill, and …” |

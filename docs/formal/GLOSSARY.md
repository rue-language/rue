...
|---|---|---|---|---|---|
| formal core; core; Core Rue; core calculus; calculus | The small, first-order, fully monomorphic language that surface Rue elaborates into, with its typing and reduction rules | [spec 1.3:1a][s1] | `Expr`, `Program` | Rue-specific, grounded | 01 intro; 03 intro; README intro; REDTEAM intro; lean/README intro; GUIDE intro; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “How it fits this package”; `Float` |
...
| prose specification; prose spec; spec; `X.Y:Z` | The human-facing Rue specification in `docs/spec/`, cited by paragraph id | [spec 1.3:1a][s1] | — | Rue-specific, grounded | 01 intro; README intro; REDTEAM “Roles”; lean/README “The bridge corpus”; GUIDE “How to read this guide”; BRIDGE-SENSITIVITY “Method”; MUTATION intro; TOOLING “The workflows”; `Float` |
...
| fragment | The part of the core that the mechanization covers today | none | — | ours, pending audit | 03 intro; README intro; lean/README intro; GUIDE §1; BRIDGE-SENSITIVITY “Method”; `Syntax` |
| library; library obligations; library bug | The trusted standard-library code behind the buffer-backed containers, the conditions (§6.13.5) it must meet, and a violation of them | none | — | ours, pending audit | 01 §2; README “Contents”; lean/README “Deciding whether to believe it”; MUTATION “Limits”; TOOLING “How it fits this package” |
...
| MUST NOT; MUST | A requirement level: an absolute prohibition, an absolute requirement | [FIELD §7][F7]: RFC 2119 §§1–2; [spec 1.4:3][s1] | — | standard | 01 §2; 03 “Linear values are consumed exactly …”; README intro; REDTEAM “Roles”; lean/README “Generated programs”; GUIDE “Fuel, and why the theorems …”; BRIDGE-SENSITIVITY “Method”; MUTATION “Method”; TOOLING “The workflows”; `Float` |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| type; types | A classification of values; the core's are integers, floats, `bool`, `unit`, `never`, structs, enums and arrays | [FIELD §2][F2]: PFPL ch. 4 (statics); [spec 1.4:12][s1] | `Ty` | standard | 01 §1; 03 intro; README “The architecture: surface → elaboration …”; lean/README “The bridge corpus”; GUIDE §1; BRIDGE-SENSITIVITY “What the numbers say”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “The module before”; `Float` |
| value; values; on values | A finished result of evaluation, which takes no step | [FIELD §1][F1]: PFPL §5.2 (`e val`) | `Val` | standard | 01 §2; 03 intro; README “Contents”; lean/README “The bridge corpus”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “Mutation score”; CHECKER-PROFILE intro; TOOLING “The module before”; `Float` |
| expression | A syntactic form that evaluates to a value | [spec 1.4:9][s1] | `Expr` | Rue-specific, grounded | 01 §2; 03 “Type safety”; README “Contents”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Distinct identities and two more …”; `Syntax` |
...
| float; float(w) | The IEEE 754 binary32 and binary64 types, `f32` and `f64` | [spec 3.12:1][s3.12] | `FloatWidth` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION “What is mutated”; TOOLING “What the review found”; `Float` |
...
| never; never type | The type `!` of an expression that transfers control away and yields no value | [spec 3.4:1][s3.4] | — | Rue-specific, grounded | 01 §2; 03 intro; README “Relationship to the prose spec”; REDTEAM “Roles”; lean/README “The bridge corpus”; GUIDE intro; BRIDGE-SENSITIVITY “Results”; MUTATION “Method”; CHECKER-PROFILE intro; TOOLING “Guardrails”; `Float` |
...
| struct; structs | A user-declared record type with named fields | [spec 6.2:1][s6.2] | `StructDecl` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; `Syntax` |
| enum; enums; variant; payload | A user-declared sum type: each variant carries a tuple of payload components | [spec 6.3:1][s6.3], [6.3:13][s6.3] | `EnumDecl` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “Golf, on a scratch copy”; `Float` |
...
| array; arrays; array element; whole array | A fixed-length sequence of `n` elements of one type, `[T; n]` | [spec 3.5:1][s3.5] | `Ty.array` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “Golf, on a scratch copy”; `Syntax` |
...
| field; fields | A named component of a struct | [spec 4.12:1][s4.12] | — | Rue-specific, grounded | 01 §2; 03 intro; README “Contents”; REDTEAM intro; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY intro; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
...
| main; program | The whole program: its declarations and functions, run from `main` | [spec 6.1:8][s6.1] | `Program`, `Program.entry` | Rue-specific, grounded | 01 §1; 03 intro; README “The architecture: surface → elaboration …”; REDTEAM intro; lean/README “The bridge corpus”; GUIDE “How to read this guide”; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE intro; TOOLING “Golf, on a scratch copy”; `Float` |
| intrinsic; `@drop`; `@panic`; `@dbg`; `@intCast`; float intrinsics `@f` | A built-in operation written with `@`, with its own typing and reduction rule | [spec 2.5:5][s2.5] | `FloatIntrin`, `Expr` | Rue-specific, grounded | 01 §2; 03 intro; README intro; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY “Results”; MUTATION “What the proofs kill, and …”; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
...
| by value | Of a parameter or argument: the callee takes ownership of the value or a copy | [spec 3.8:62][s3.8] | — | Rue-specific, grounded | 01 §2; BRIDGE-SENSITIVITY “Multi-function programs”; `Syntax` |
...
| step (of a path) | One field or index selection within a path | none | `Ty.fieldAt` | ours, pending audit | 01 §2; 03 intro; README “The architecture: surface → elaboration …”; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE “How to read this guide”; BRIDGE-SENSITIVITY “Rule coverage”; MUTATION “What is mutated”; TOOLING “The workflows”; `Float` |
...
| `Copy` | The class whose values may be used any number of times and dropped | [spec 3.8:2][s3.8]; FIELD §4: "unrestricted" (Walker), partial | `Mult.copy` | Rue-specific, grounded | 01 §2; 03 intro; README “The extension rubric”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “How it fits this package”; `Syntax` |
...
| declared-linear; declared | Of a struct: marked `linear` itself, not linear only by infection | [spec 3.8:30][s3.8], [3.8:33][s3.8] | `Ty.declaredLinear` | Rue-specific, grounded | 01 §3; 03 intro; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
...
| copies; copy | A use that duplicates a `Copy` value and leaves its place as it was | [spec 3.8:1][s3.8] | — | Rue-specific, grounded | 01 §2; 03 intro; README “The extension rubric”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY intro; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “How it fits this package”; `Syntax` |
...
| borrows; borrow; shared loan; loans; loan | A temporary, call-scoped right to read (shared) or write (exclusive) a place without taking it | [FIELD §5][F5]: borrow, loan (Polonius, Oxide); `inout`/`borrow` differ, partial | — | ours, pending audit | 01 intro; 03 intro; README intro; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Never exercised”; `Syntax` |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| statics; static; statically; static semantics; typing | The type system: the rules that decide which programs are well-formed | [FIELD §1][F1]: PFPL chs. 4–5 (statics / dynamics) | `Typed` | standard | 01 §2; 03 intro; README intro; lean/README “The bridge corpus”; GUIDE §1; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “What the review found”; `Float` |
...
| stuck; stuck configuration | Not terminal, and no rule applies | [FIELD §1][F1]: PFPL ch. 6; Plotkin §3.1 Def. 11 | `Config.Stuck` | standard | 01 §6.1; 03 intro; lean/README “Generated programs”; GUIDE §2; MUTATION “What is mutated”; TOOLING “The workflows”; `Float` |
| stuck (the interpreter's refusal); monitored stuck | `eval`'s named refusal of a step, including the four checks §6 does not have | [FIELD §1][F1]: `EvalRes.stuck` differs, partial | `EvalRes`, `Violation` | ours, pending audit | 01 §6.1; 03 intro; lean/README “Generated programs”; GUIDE §2; MUTATION “What is mutated”; TOOLING “The workflows”; `Float` |
...
| executable; executable semantics; executable reference interpreter | A semantics that runs programs as well as defining them | [FIELD §7][F7]: executable model (Cedar) | `eval` | standard | 01 §5.4; README “The executable oracle”; lean/README “Deciding whether to believe it”; GUIDE §7; MUTATION “What the proofs kill, and …”; `Float` |
...
| trap; traps; `↯κ`; trap on overflow | A defined run-time failure that halts the program with exit code 101 | [FIELD §1][F1]: checked error (PFPL §6.3), partial; [spec 8.1:1][s8.1] | `PanicKind` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “Method”; MUTATION “What is mutated”; `Float` |
| panic; panics; `@panic` | A trap raised by the program, or any trap | [spec 1.4:18][s1], [4.13:5c][s4.13] | `PanicKind` | Rue-specific, grounded | 01 §2; 03 intro; README intro; lean/README “The bridge corpus”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “What the proofs kill, and …”; `Float` |
| result; outcome; exit code | What a finished run reports: exit status and output | [spec 6.1:8][s6.1] (exit code) | `EvalRes` | Rue-specific, grounded | 01 §2; 03 intro; README “The executable oracle”; lean/README “The bridge corpus”; GUIDE §1; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE “The one exception: RUE-2346, already …”; TOOLING “Golf, on a scratch copy”; `Float` |
...
| run | A whole evaluation of a program from its initial configuration | [FIELD §6][F6]: run (Leucker & Schallhart) | `run` | standard | 01 §1; 03 intro; README intro; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE intro; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE intro; TOOLING “How it fits this package”; `Float` |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| theorem; theorems; proved; proved about | A statement with a kernel-checked proof | [FIELD §8][F8]: `theorem` vs `def` (Reference §7.4) | — | standard | 01 §2; 03 intro; README intro; REDTEAM intro; lean/README intro; GUIDE intro; MUTATION intro; CHECKER-PROFILE intro; TOOLING “The module before”; `Float` |
...
| claim; claim as a whole | Every headline statement together with the definitions they use, as the red team attacks them | none | — | ours, pending audit | 01 §2; 03 intro; README intro; REDTEAM intro; lean/README “Generated programs”; GUIDE “One program, traced both ways”; MUTATION “The mutants”; `Dynamics` |
...
| soundness (of `eval`); sound | Every value and panic `eval` answers, §6's reduction also reaches | [FIELD §3][F3]: one direction of semantic equivalence (Amin & Rompf); FIELD's "differs" row for `eval_sound` | `eval_sound` | ours, pending audit | 01 §3; 03 intro; README “Why comptime is elaboration, not …”; lean/README intro; GUIDE §2; MUTATION “What is mutated”; CHECKER-PROFILE intro; TOOLING “How it fits this package”; `Float` |
...
| `Matches`; `FrameMatches`; `ContentsMatches` | The invariant: each cell agrees with its binding's type and ownership state | [FIELD §2][F2]: "`Matches`" differs, partial | `Matches`, `FrameMatches`, `ContentsMatches` | ours, pending audit | 01 §5.5; 03 “Type safety”; lean/README “How to read this, with …”; GUIDE §3; MUTATION “What is mutated”; `Syntax` |
...
| verdict | The checker's accept or reject on a corpus case | [FIELD §7][F7]: "verdict" differs, none | `checkProgram` | ours, pending audit | 03 “Lemmas §7 owes, and the …”; README “The executable oracle”; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE §4; BRIDGE-SENSITIVITY “Rule coverage”; MUTATION “Method”; CHECKER-PROFILE “Why a rejected program still …”; `Checker.Defs` |
| red case; disagreement | A corpus case on which two of the compared systems disagree | [FIELD §7][F7]: "red case" differs, partial | — | ours, pending audit | 01 §5.5; 03 “Type safety”; README intro; lean/README “The bridge corpus”; GUIDE “One program, traced both ways”; BRIDGE-SENSITIVITY “Method”; MUTATION “What is mutated”; CHECKER-PROFILE intro; `Statics` |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| verified | Of a compiler or validator: proved correct against a specification (Leroy); the docs never use this sense of the checker or the interpreter — the checker is proved sound only, and `eval` is proved adequate to §6's `Step` (`eval_sound`, `eval_complete`), not itself the specification. Where the docs use "verified", it means confirmed against the compiler, confirmed by hand, or kernel-checked | [FIELD §7][F7]: verified compiler, verified validator (Leroy CACM §2.2) | — | standard | 01 §2; 03 “Linear values are consumed exactly …”; lean/README “What is mechanized”; GUIDE §6; BRIDGE-SENSITIVITY “Results”; TOOLING “Guardrails”; `Float` |
| kernel; kernel-checked | Lean's small type checker, which re-checks every proof | [FIELD §8][F8]: Reference §2 | — | standard | 03 intro; README intro; lean/README “Deciding whether to believe it”; GUIDE “The one edge no monitor …”; MUTATION intro; TOOLING “What we decline, and why”; `Float` |
...
| shape; shapes | Of a state or declaration environment: its structure with the particular values left out | none | `Contents.skeleton`, `Ctx.SameSkel` | ours, pending audit | 01 §5; 03 intro; README intro; lean/README intro; GUIDE intro; BRIDGE-SENSITIVITY “Method”; MUTATION “What the proofs kill, and …”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |

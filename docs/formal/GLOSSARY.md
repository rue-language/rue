...
| root; root binding | The local binding a place starts from | [spec 6.1:43][s6.1] ("a place rooted at") | `Place.root` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Building”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “Reading a proof failure”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “Guardrails”; `Float` |
...
| terminal | Of a configuration: finished, a value returned to the bottom of the stack or a trap | [FIELD §1][F1]: Plotkin §1.2 Def. 2 (terminal transition system) | `Config.Terminal` | standard | 03 “No use-after-drop / no leak …”; lean/README “What is mechanized”; GUIDE §2; MUTATION “Mutation score”; `Step` |

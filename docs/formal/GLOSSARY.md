...
| claim; claim as a whole | Every headline statement together with the definitions they use, as the red team attacks them | none | — | ours, pending audit | 01 §2; 03 intro; README intro; REDTEAM intro; lean/README “Explaining a program”; GUIDE “One program, traced both ways”; MUTATION “Proposed issues”; `Dynamics` |
...
| `dropEvents` | `Dynamics` | §6.11's drop order written out: the trace events dropping some contents emits, destructor first | Rue-specific, grounded (spec 3.9:28) | 03 “No double-free”; GUIDE “The three trace theorems, one …”; MUTATION “What the proofs kill, and …”; `Trace.Defs` |
...
| `stepN` | `Step` | Takes up to `n` steps, stopping early | helper | lean/README “What is mechanized”; GUIDE §2 |

...
[lean/MUTATION.md](lean/MUTATION.md),
[lean/CHECKER-PROFILE.md](lean/CHECKER-PROFILE.md),
[lean/TOOLING.md](lean/TOOLING.md), and the doc-comments of the mechanization's
...
|---|---|---|---|---|---|
| formal core; core; Core Rue; core calculus; calculus | The small, first-order, fully monomorphic language that surface Rue elaborates into, with its typing and reduction rules | [spec 1.3:1a][s1] | `Expr`, `Program` | Rue-specific, grounded | 01 intro; 03 intro; README intro; WHAT-IT-MEANS intro; REDTEAM intro; lean/README intro; GUIDE intro; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “How it fits this package”; `Float` |
...
| comptime | Rue's compile-time evaluation, which elaboration runs away before the core | [spec 4.14:1][s4.14] | — | Rue-specific, grounded | 01 §1; README “The architecture: surface → elaboration …”; WHAT-IT-MEANS “What is modelled”; BRIDGE-SENSITIVITY “Follow-ups” |
...
| prose specification; prose spec; spec; `X.Y:Z` | The human-facing Rue specification in `docs/spec/`, cited by paragraph id | [spec 1.3:1a][s1] | — | Rue-specific, grounded | 01 intro; README intro; WHAT-IT-MEANS intro; REDTEAM “Roles”; lean/README “The bridge corpus”; GUIDE “How to read this guide”; BRIDGE-SENSITIVITY “Method”; MUTATION intro; TOOLING “The workflows”; `Float` |
...
| `_` in payload-binding position; wildcard | A match-arm pattern slot that binds a payload component without naming it | [spec 4.7:30][s4.7], [4.7:4][s4.7] | — | Rue-specific, grounded | 01 §2; 03 intro; lean/README “What is mechanized”; MUTATION “What is mutated”; `Syntax` |
...
| continue | The surface form that ends a loop iteration early | [spec 4.8:10][s4.8] | — | Rue-specific, grounded | 01 §2; 03 intro; WHAT-IT-MEANS “What is modelled”; lean/README “What is mechanized”; GUIDE §1; `Syntax` |
...
| MUST NOT; MUST | A requirement level: an absolute prohibition, an absolute requirement | [FIELD §7][F7]: RFC 2119 §§1–2; [spec 1.4:3][s1] | — | standard | 01 §2; 03 “Linear values are consumed exactly …”; README intro; WHAT-IT-MEANS “How this connects to the …”; REDTEAM “Roles”; lean/README “Generated programs”; GUIDE “Fuel, and why the theorems …”; BRIDGE-SENSITIVITY “Method”; MUTATION “Method”; TOOLING “The workflows”; `Float` |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| type; types | A classification of values; the core's are integers, floats, `bool`, `unit`, `never`, structs, enums and arrays | [FIELD §2][F2]: PFPL ch. 4 (statics); [spec 1.4:12][s1] | `Ty` | standard | 01 §1; 03 intro; README “The architecture: surface → elaboration …”; WHAT-IT-MEANS “What is modelled”; lean/README “The bridge corpus”; GUIDE §1; BRIDGE-SENSITIVITY “What the numbers say”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “The module before”; `Float` |
| value; values; on values | A finished result of evaluation, which takes no step | [FIELD §1][F1]: PFPL §5.2 (`e val`) | `Val` | standard | 01 §2; 03 intro; README “Contents”; WHAT-IT-MEANS “What is modelled”; lean/README “The bridge corpus”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “Mutation score”; CHECKER-PROFILE intro; TOOLING “The module before”; `Float` |
| expression | A syntactic form that evaluates to a value | [spec 1.4:9][s1] | `Expr` | Rue-specific, grounded | 01 §2; 03 “Type safety”; README “Contents”; WHAT-IT-MEANS “What is proved”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Distinct identities and two more …”; `Syntax` |
| integer; int(w, s); width; signedness; signed | The integer types, fixed by width in bits (8 to 64) and signedness | [spec 3.1:1][s3.1] | `IntWidth`, `Sign` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §4; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; TOOLING “How it fits this package”; `Float` |
| float; float(w) | The IEEE 754 binary32 and binary64 types, `f32` and `f64` | [spec 3.12:1][s3.12] | `FloatWidth` | Rue-specific, grounded | 01 §2; 03 intro; WHAT-IT-MEANS “How we know the proofs …”; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION “What is mutated”; TOOLING “What the review found”; `Float` |
| unit | The type with exactly one value, `()` | [spec 3.3:1][s3.3] | `Ty.unit` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §2; MUTATION “The mutants”; `Syntax` |
| never; never type | The type `!` of an expression that transfers control away and yields no value | [spec 3.4:1][s3.4] | — | Rue-specific, grounded | 01 §2; 03 intro; README “Relationship to the prose spec”; WHAT-IT-MEANS “What is proved”; REDTEAM “Roles”; lean/README “The bridge corpus”; GUIDE intro; BRIDGE-SENSITIVITY “Results”; MUTATION “Method”; CHECKER-PROFILE intro; TOOLING “Guardrails”; `Float` |
...
| struct; structs | A user-declared record type with named fields | [spec 6.2:1][s6.2] | `StructDecl` | Rue-specific, grounded | 01 §2; 03 intro; WHAT-IT-MEANS “What is modelled”; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; `Syntax` |
| enum; enums; variant; payload | A user-declared sum type: each variant carries a tuple of payload components | [spec 6.3:1][s6.3], [6.3:13][s6.3] | `EnumDecl` | Rue-specific, grounded | 01 §2; 03 intro; WHAT-IT-MEANS “What is modelled”; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “Golf, on a scratch copy”; `Float` |
| active; active variant | The one variant an enum value holds at run time | [spec 6.3:20][s6.3] | — | Rue-specific, grounded | 01 §3; 03 intro; lean/README “The statement layer”; GUIDE “The three trace theorems, one …”; TOOLING “Guardrails”; `Syntax` |
...
| array; arrays; array element; whole array | A fixed-length sequence of `n` elements of one type, `[T; n]` | [spec 3.5:1][s3.5] | `Ty.array` | Rue-specific, grounded | 01 §2; 03 intro; WHAT-IT-MEANS “What is modelled”; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “Golf, on a scratch copy”; `Syntax` |
| index; index step; constant; constant index | An array element selection `p[e]`; a constant one is fixed at compile time, and only constant ones are tracked statically | [spec 3.8:68][s3.8], [3.5:7][s3.5] | `Expr.indexRead`, `Expr.indexWrite` | Rue-specific, grounded | 01 §2; 03 intro; README “Contents”; lean/README “Building”; GUIDE “How to read this guide”; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
...
| field; fields | A named component of a struct | [spec 4.12:1][s4.12] | — | Rue-specific, grounded | 01 §2; 03 intro; README “Contents”; WHAT-IT-MEANS “What is proved”; REDTEAM intro; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY intro; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
| declaration; declarations; declaration order; declared | A struct, enum or function definition; "declaration order" is the order fields are written | [spec 3.9:17][s3.9] (declaration order) | `Decls` | Rue-specific, grounded | 01 §2; 03 intro; README “Contents”; WHAT-IT-MEANS “What is proved”; lean/README “Building”; GUIDE “How to read this guide”; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; CHECKER-PROFILE intro; TOOLING “The workflows”; `Float` |
| attribute; no attribute | A struct's `@copy` or `linear` marker, which fixes or raises its class | [spec 3.8:14][s3.8], [3.8:30][s3.8] | `Attr` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “The proof map”; GUIDE “What the checker demands”; `Float` |
| literal; literals | A constant written in the program text | [spec 2.1:29][s2.1] | — | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “§6 step rows”; MUTATION “What the proofs kill, and …”; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
...
| resolution | Giving a literal its concrete type from context before the core | [spec 2.1:29][s2.1] (a float literal takes its type from context) | — | Rue-specific, grounded | 01 §2; MUTATION “Survivors and their resolution”; `Syntax` |
| function; parameter; argument | A function definition, its declared inputs, and the operands a call passes | [spec 6.1:1][s6.1] | `FnDef`, `Param` | Rue-specific, grounded | 01 §1; 03 intro; README “The architecture: surface → elaboration …”; lean/README “The bridge corpus”; GUIDE intro; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “How it fits this package”; `Float` |
| main; program | The whole program: its declarations and functions, run from `main` | [spec 6.1:8][s6.1] | `Program`, `Program.entry` | Rue-specific, grounded | 01 §1; 03 intro; README “The architecture: surface → elaboration …”; WHAT-IT-MEANS intro; REDTEAM intro; lean/README “The bridge corpus”; GUIDE “How to read this guide”; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE intro; TOOLING “Golf, on a scratch copy”; `Float` |
| intrinsic; `@drop`; `@panic`; `@dbg`; `@intCast`; float intrinsics `@f` | A built-in operation written with `@`, with its own typing and reduction rule | [spec 2.5:5][s2.5] | `FloatIntrin`, `Expr` | Rue-specific, grounded | 01 §2; 03 intro; README intro; WHAT-IT-MEANS “What is modelled”; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY “Results”; MUTATION “What the proofs kill, and …”; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
...
| operand; operator; arithmetic | An operator's inputs; the built-in arithmetic, bitwise, shift and comparison operators | [spec 4.2:1][s4.2] | `BinOp`, `UnOp` | Rue-specific, grounded | 01 §2; 03 intro; README “Contents”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Method”; MUTATION “What is mutated”; `Float` |
...
| `if`; `match`; `loop`; loops; `break`; `return` | The core's control forms: two-way branch, enum elimination, the infinite loop, its exit, and function return | [spec 4.6:1][s4.6], [4.7:1][s4.7], [4.8:18][s4.8], [4.9:1][s4.9] | `Expr` | Rue-specific, grounded | 01 §2; 03 intro; README “The architecture: surface → elaboration …”; WHAT-IT-MEANS “What is modelled”; REDTEAM intro; lean/README “The bridge corpus”; GUIDE §1; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE intro; TOOLING intro; `Float` |
| assignment; `assign`; target | Storing a new value into a place, the target; the right-hand side is evaluated first | [spec 5.2:14][s5.2] | `Expr.assign` | Rue-specific, grounded | 01 §2; 03 intro; WHAT-IT-MEANS “What is modelled”; REDTEAM “Targets”; lean/README “Building”; GUIDE §5; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION “Method”; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
...
| binding; `let`; local | A named local variable, introduced by `let` or a pattern | [spec 5.1:1][s5.1] | `Expr.letIn` | Rue-specific, grounded | 01 §2; 03 intro; README “The architecture: surface → elaboration …”; WHAT-IT-MEANS “What is modelled”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
| mutable; `mut`; unmarked | Of a place: it may be assigned, because its root is a `mut` binding or an `inout` parameter | [spec 6.1:43][s6.1] | — | Rue-specific, grounded | 01 §2; lean/README “Generated programs”; GUIDE §5; BRIDGE-SENSITIVITY “Observable destructors”; MUTATION “Reading a proof failure”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
| `inout`; `borrow`; by-reference argument | The two parameter modes that pass a place by exclusive or shared reference instead of by value | [spec 6.1:30][s6.1] | — | Rue-specific, grounded | 01 §2; 03 intro; README “The architecture: surface → elaboration …”; WHAT-IT-MEANS intro; lean/README “Generated programs”; `Syntax` |
| by value | Of a parameter or argument: the callee takes ownership of the value or a copy | [spec 3.8:62][s3.8] | — | Rue-specific, grounded | 01 §2; WHAT-IT-MEANS “What is modelled”; BRIDGE-SENSITIVITY “Multi-function programs”; `Syntax` |
| grammar; abstract syntax | The abstract syntax: the productions of §2 | none; FIELD §9 has PFPL's abstract syntax trees (§1.2), not the word ([FIELD §9][F9]) | `Expr`, `Ty` | ours, pending audit | 01 §2; 03 intro; README “The extension rubric”; lean/README “Doc-comment convention”; GUIDE “The three trace theorems, one …”; MUTATION “What the proofs kill, and …”; `Float` |
| step (of a path) | One field or index selection within a path | none | `Ty.fieldAt` | ours, pending audit | 01 §2; 03 intro; README “The architecture: surface → elaboration …”; WHAT-IT-MEANS “What is proved”; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE “How to read this guide”; BRIDGE-SENSITIVITY “Rule coverage”; MUTATION “What is mutated”; TOOLING “The workflows”; `Float` |

### Substructural classes

| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| class; multiplicity class | Which of the three usage disciplines a type follows: `Copy`, `Affine` or `Linear` | [FIELD §4][F4] (qualifier); "class" differs, partial | `Mult`, `Ty.mult` | ours, pending audit | 01 §2; 03 intro; README “Contents”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Distinct identities and two more …”; MUTATION “What is mutated”; CHECKER-PROFILE intro; `Syntax` |
| `Copy` | The class whose values may be used any number of times and dropped | [spec 3.8:2][s3.8]; FIELD §4: "unrestricted" (Walker), partial | `Mult.copy` | Rue-specific, grounded | 01 §2; 03 intro; README “The extension rubric”; WHAT-IT-MEANS “What is modelled”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “How it fits this package”; `Syntax` |
| affine; `Affine`; move type | The class whose values may be used at most once and may be dropped | [FIELD §4][F4]: Walker §1.1; [spec 3.8:1][s3.8] | `Mult.affine` | standard | 01 §2; 03 “Linear values are consumed exactly …”; README “Contents”; lean/README “Generated programs”; GUIDE §3; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; `Syntax` |
| linear; `Linear`; `linear` | The class whose values must be used exactly once and may not be dropped | [FIELD §4][F4]: Walker §1.1; [spec 3.8:30][s3.8] | `Mult.linear` | standard | 01 intro; 03 intro; README “The architecture: surface → elaboration …”; WHAT-IT-MEANS “What is modelled”; REDTEAM “Targets”; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
| contraction; weakening | The structural rules that allow an assumption to be used twice, or not at all | [FIELD §4][F4]: Walker §1.1 | — | standard | 01 §3; MUTATION “What the proofs kill, and …”; `Syntax` |
...
| join; `⊔` | The least upper bound of two classes, the more restrictive of the two | [FIELD §9][F9]: Tarski 1955 §1 (least upper bound, join); [FIELD §4][F4]: Tov & Pucella (`⊔`) | `Mult.join` | standard | 01 §3; 03 intro; lean/README “Generated programs”; GUIDE §3; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION intro; CHECKER-PROFILE intro; TOOLING “What the review found”; `Float` |
| infectious; infectiousness; by infection; lifting | A struct takes at least the class of its most restrictive field | [spec 3.8:58][s3.8] ("linearity is infectious"); FIELD §4 differs, partial | `Attr.lift` | Rue-specific, grounded | 01 §3; 03 “Linear values are consumed exactly …”; MUTATION “Mutation score”; `Syntax` |
| carries a linear value; `carries_linear` | Of a type: it is linear, or contains a linear component at some depth | [spec 3.8:57][s3.8] | `Ty.carriesLinear` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §3; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| place; places; place expression; location | An expression that denotes a storage location: a binding, a field of a place, or an element of a place | [FIELD §5][F5]: Rust Reference *Expressions*; Oxide | `Place` | standard | 01 §2; 03 intro; README “Why not just formalize the …”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “§6 step rows”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
| path; paths | The route from a place's root binding to it, as a list of field and index steps | [FIELD §5][F5]: Polonius (path); rustc-dev-guide (move path) | `Place.path` | standard | 01 §4.2; 03 intro; README intro; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “The mutants”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “How it fits this package”; `Syntax` |
| root; root binding | The local binding a place starts from | [spec 6.1:43][s6.1] ("a place rooted at") | `Place.root` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Building”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “Reading a proof failure”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “How it fits this package”; `Float` |
| projection; projected from | Selecting a field or element of a place (`p.f`, `p[e]`) | [spec 3.8:76][s3.8] (field projection) | — | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; MUTATION “Proposed issues”; `Syntax` |
| sub-places; sibling; sibling position | A place under another; a place beside it under the same parent; an operand beside another in one construct | [spec 3.8:76][s3.8], [3.8:22][s3.8] (sub-place, sibling fields) | — | Rue-specific, grounded | 01 §2; 03 “No use-after-move”; lean/README “How to read this, with …”; GUIDE §4; MUTATION intro; `Float` |
...
| leaf; selected leaf; selected leaf's; selected path | The place a projection finally selects, and the path to it | [spec 3.8:33][s3.8] ("produces the selected field") | — | Rue-specific, grounded | 01 §2; 03 intro; README “Contents”; lean/README “Generated programs”; GUIDE “What the checker demands”; BRIDGE-SENSITIVITY “Distinct identities and two more …”; `Syntax` |
| outermost | Of array places on a path: the one nearest the root | none | `arrayPrefix` | ours, pending audit | 01 §5.2; lean/README “Generated programs”; GUIDE §1; MUTATION “RUE-2490: the statement vocabulary and …”; `Syntax` |
...
| use; used | An occurrence of a place in value context; it copies a `Copy` value and moves any other | [spec 3.8:76][s3.8] | `Typed.useCopy`, `Typed.useMove` | Rue-specific, grounded | 01 intro; 03 intro; README intro; WHAT-IT-MEANS “How we know the proofs …”; REDTEAM intro; lean/README “Building”; GUIDE §1; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “What the review found”; `Float` |
| move; moves; moved; moved or copied into | A use that transfers a non-`Copy` value out of its place, which becomes unusable until reinitialized | [FIELD §5][F5]: moved from (Rust Reference *Expressions*); [spec 3.8:7][s3.8] | `Typed.useMove` | standard | 01 intro; 03 intro; README “The architecture: surface → elaboration …”; WHAT-IT-MEANS “What is modelled”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Method”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
| consumes; consumed; consumption | Moving a value into a function, a return, or a destructure, which discharges its obligation to be used; for a linear value, the one permitted use | [spec 3.8:33][s3.8] | — | Rue-specific, grounded | 01 intro; 03 intro; README “The architecture: surface → elaboration …”; WHAT-IT-MEANS “What is proved”; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY “Observable destructors”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
...
| copies; copy | A use that duplicates a `Copy` value and leaves its place as it was | [spec 3.8:1][s3.8] | — | Rue-specific, grounded | 01 §2; 03 intro; README “The extension rubric”; WHAT-IT-MEANS “What is modelled”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY intro; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “How it fits this package”; `Syntax` |
...
| partial move; partial; element-wise partial move | A move of one field or constant-index element, leaving its siblings in place | [FIELD §5][F5]: Rust Reference *Patterns*, *Destructors* | `OwnSt.fields` | standard | 01 §2; 03 intro; README “Why comptime is elaboration, not …”; lean/README “The trusted-base lint”; GUIDE §2; BRIDGE-SENSITIVITY “Results”; MUTATION intro; `Syntax` |
...
| ownership state; `Owned`; `MovedOut`; owned | The static record, per path, of whether a place owns its value or has been moved out | [spec 3.8:79][s3.8] (the ownership state of a binding); FIELD §5: `MovedOut` is "moved from" (clear), `Owned` partial ([FIELD §5][F5]) | `OwnSt` | Rue-specific, grounded | 01 §4.1; 03 intro; README “The extension rubric”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
...
| owes a drop; owes `x` a drop | A scope owes a binding a drop when the binding will be dropped at the scope's exit | none | — | ours, pending audit | 01 §6.7; lean/README “What is mechanized”; GUIDE §2; `Dynamics` |
| borrows; borrow; shared loan; loans; loan | A temporary, call-scoped right to read (shared) or write (exclusive) a place without taking it | [FIELD §5][F5]: borrow, loan (Polonius, Oxide); `inout`/`borrow` differ, partial | — | ours, pending audit | 01 intro; 03 intro; README intro; WHAT-IT-MEANS intro; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Never exercised”; `Syntax` |
| law of exclusivity; exclusivity | A place lent for writing may not be accessed any other way while the loan lasts | [FIELD §5][F5]: Swift SE-0176 | — | standard | 01 §5; 03 “Exclusivity / no aliased mutation”; README intro |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| statics; static; statically; static semantics; typing | The type system: the rules that decide which programs are well-formed | [FIELD §1][F1]: PFPL chs. 4–5 (statics / dynamics) | `Typed` | standard | 01 §2; 03 intro; README intro; WHAT-IT-MEANS intro; lean/README “The bridge corpus”; GUIDE §1; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “What the review found”; `Float` |
| judgment; typing judgment | A statement the rules derive, here `Γ;Σ;Λ ⊢ e ⇒ R ⊣ Ω` | [FIELD §9][F9]: PFPL §§2.1–2.4; [FIELD §2][F2]: `Γ ⊢ e : τ` | `Typed` | standard | 01 intro; 03 “Lemmas §7 owes, and the …”; README “The executable oracle”; lean/README “How to read this, with …”; GUIDE intro; MUTATION “What is mutated”; CHECKER-PROFILE intro; `Float` |
| derivation | A tree of rule instances that proves a judgment | [FIELD §9][F9]: PFPL ch. 2 | `Typed` | standard | 01 §3; 03 “No use-after-drop / no leak …”; lean/README “Explaining a program”; GUIDE §1; BRIDGE-SENSITIVITY “Rule coverage”; CHECKER-PROFILE “Reproducing”; `Syntax` |
| well-typed | Of a program or expression: some typing derivation exists for it | [FIELD §2][F2]: PFPL Thm 6.4 (progress, for well-typed terms) | `HasTy` | standard | 01 §6.1; 03 intro; lean/README “How to read this, with …”; GUIDE §1; BRIDGE-SENSITIVITY “Distinct identities and two more …”; MUTATION “Readings the spec pass corrected”; `Float` |
| well-formed; ill-formed | Of a program or declaration: it satisfies, or violates, the static rules | [FIELD §9][F9]: PFPL §1.2, ch. 4; [spec 2.0:9][s2], [6.6:10][s6.6] | `WfProgram`, `WfDecls` | standard | 01 §1; 03 “Type safety”; GUIDE “What the checker demands”; `Syntax` |
...
| reachable | Of a configuration or edge: some run from the start reaches it | [FIELD §2][F2]: `safe(e)`, every state reachable from e (Timany §2.4); [spec 3.8:79][s3.8] (reachable back edge) | `Steps` | standard | 01 §2; 03 “No use-after-drop / no leak …”; lean/README “Generated programs”; GUIDE “What the checker demands”; BRIDGE-SENSITIVITY “Multi-function programs”; MUTATION “The mutants”; `Statics` |
...
| threading; threads | Passing the ownership state through a judgment, from the state before an expression to the state after it | none | `Typed` | ours, pending audit | 01 §5; README “The extension rubric”; REDTEAM “Roles”; lean/README “What is mechanized”; GUIDE “What the checker demands”; MUTATION “What is mutated”; `Statics` |
| incoming; outgoing; outgoing state | The ownership state before an expression, and the one it leaves after | [FIELD §4][F4]: "outgoing state" differs, partial (Walker's algorithmic `Γ₁ ⊢ t : T; Γ₂`) | `Out` | ours, pending audit | 01 §5.3; 03 “Type safety”; lean/README “How to read this, with …”; GUIDE §1; MUTATION “Equivalent mutants”; CHECKER-PROFILE “Why a rejected program still …”; `Statics` |
...
| diverging; divergence (static); diverging edge | Of an expression: it transfers control away instead of yielding a value to its context | [spec 3.4:1][s3.4] | — | Rue-specific, grounded | 01 §2; 03 “Type safety”; lean/README “The bridge corpus”; GUIDE §1; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION “What is mutated”; `Statics` |
| never-coercion; subsumption on the bottom type; single (coercion) | The one coercion: an expression of type `never` may stand at any type | [spec 3.4:3][s3.4] | `Typed` | Rue-specific, grounded | 01 §2; 03 “No double-free”; README “Why comptime is elaboration, not …”; lean/README “Explaining a program”; GUIDE §2; BRIDGE-SENSITIVITY “Never exercised”; TOOLING “Golf, on a scratch copy”; `Statics` |
...
| continuing; continue (an arm) | Of an arm or expression: it has a normal outgoing state, rather than only diverging | none | `Out` | ours, pending audit | 01 §2; 03 intro; WHAT-IT-MEANS “What is modelled”; lean/README “What is mechanized”; GUIDE §1; `Syntax` |
| branch join; reconcile | Combining the outgoing states of an `if`'s or `match`'s arms into one | [spec 3.8:80][s3.8] (join of states on all edges) | `Ctx.join`, `Ctx.joinAll` | Rue-specific, grounded | 01 §5.3; 03 “Lemmas §7 owes, and the …”; lean/README “What is mechanized”; CHECKER-PROFILE intro; `Syntax` |
| back edge; break edges | The loop's re-entry into its body, and its exits by `break` | [spec 3.8:79][s3.8] | — | Rue-specific, grounded | 01 §2; 03 “Type safety”; lean/README “Non-vacuity witnesses”; GUIDE “Loops, briefly”; `Syntax` |
| loop head; loop-head state | The ownership state at the top of every iteration: the entry state joined with the states at the back edges | [spec 3.8:79][s3.8] (the loop head) | `LoopHead` | Rue-specific, grounded | 01 §5.7; 03 “Lemmas §7 owes, and the …”; lean/README “What is mechanized”; GUIDE “Loops, briefly”; MUTATION “The mutants”; CHECKER-PROFILE intro; `Statics` |
| fixpoint | A point that a function maps to itself; the loop-head state is the least one of §5.7's equation | [FIELD §9][F9]: Tarski 1955 §1 | `LoopHead` | standard | 01 §5.7; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
| leak check; must-use check; drop obligation | At scope exit, a still-owned linear value is an error, and any other still-owned droppable value is dropped | [spec 3.8:32][s3.8], [3.8:62][s3.8] | `NoResidualLinear`, `residualLinear` | Rue-specific, grounded | 01 §5.3; 03 intro; lean/README “What is mechanized”; GUIDE §3; BRIDGE-SENSITIVITY “§5 derivation nodes”; CHECKER-PROFILE “Why a rejected program still …”; `Statics` |
| discard; discards; sequencing | Evaluating an expression for its effect and ignoring its value, `e1 ; e2` | [spec 3.8:64][s3.8] | `Expr.seq` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE “The one edge no monitor …”; MUTATION “What is mutated”; `Syntax` |
| scope exit; scope | The end of a binding's scope, where it is dropped or checked | [spec 3.9:18][s3.9] | — | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “Install and scope”; `Syntax` |
...
| exhaustiveness | Every variant of the scrutinee's enum has an arm | [spec 4.7:1][s4.7] | `TypedArms` | Rue-specific, grounded | 01 §5.5; 03 “Type safety”; lean/README “What is mechanized”; GUIDE “What the checker demands”; MUTATION “The mutants”; `Statics` |
| algorithm; algorithmic; checker | The decision procedure that computes a type and outgoing state, as opposed to the declarative rules | [FIELD §4][F4]: Walker 1.2.9 (algorithmic soundness) | `check`, `checkProgram` | standard | 01 §5.3; 03 “No use-after-drop / no leak …”; README “The executable oracle”; WHAT-IT-MEANS intro; lean/README “Building”; GUIDE intro; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE intro; TOOLING “How it fits this package”; `Statics` |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| dynamics; dynamic; dynamic semantics; runtime | The rules that say how a program runs | [FIELD §1][F1]: PFPL chs. 4–5 | `eval`, `Step` | standard | 01 §2; 03 intro; README intro; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
| small-step; reduction relation; `→`; step; steps | The relation that takes one configuration to the next by one rule | [FIELD §1][F1]: small-step (Plotkin 2004b; SF *Smallstep*) | `Step`, `Steps` | standard | 01 §2; 03 intro; README “The architecture: surface → elaboration …”; WHAT-IT-MEANS intro; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE intro; BRIDGE-SENSITIVITY “Rule coverage”; MUTATION “What is mutated”; TOOLING “The workflows”; `Float` |
| configuration; initial configuration | The machine's whole state: store, frame, control stack and focus, or a halted result | [FIELD §1][F1]: Plotkin §1.2 (transition system; configuration) | `Config`, `Config.init` | standard | 01 §6.1; 03 intro; README “The extension rubric”; REDTEAM “Targets”; lean/README “Layers”; GUIDE §2; MUTATION “The mutants”; `Dynamics` |
| terminal | Of a configuration: finished, a value returned to the bottom of the stack or a trap | [FIELD §1][F1]: Plotkin §1.2 Def. 2 (terminal transition system) | `Config.Terminal` | standard | 03 “No use-after-drop / no leak …”; lean/README “Sharpness counter-examples”; GUIDE §2; MUTATION “Mutation score”; `Step` |
| stuck; stuck configuration | Not terminal, and no rule applies | [FIELD §1][F1]: PFPL ch. 6; Plotkin §3.1 Def. 11 | `Config.Stuck` | standard | 01 §6.1; 03 intro; WHAT-IT-MEANS “What is proved”; lean/README “Generated programs”; GUIDE §2; MUTATION “What is mutated”; TOOLING “The workflows”; `Float` |
| stuck (the interpreter's refusal); monitored stuck | `eval`'s named refusal of a step, including the four checks §6 does not have | [FIELD §1][F1]: `EvalRes.stuck` differs, partial | `EvalRes`, `Violation` | ours, pending audit | 01 §6.1; 03 intro; WHAT-IT-MEANS “What is proved”; lean/README “Generated programs”; GUIDE §2; MUTATION “What is mutated”; TOOLING “The workflows”; `Float` |
| determinism; deterministic | Every configuration has at most one successor | [FIELD §1][F1]: PFPL Lemma 5.3 | `step` | standard | 01 §2; 03 “Lemmas §7 owes, and the …”; lean/README “What is mechanized”; GUIDE §2; MUTATION “The mutants”; `Step` |
| evaluation context; evaluation contexts; `E` | An expression with one hole, placed where the next step happens | [FIELD §1][F1]: Felleisen & Hieb §2; PFPL §5.3 | `Kont` | standard | 01 §2; 03 intro; README “Relationship to the prose spec”; lean/README “The bridge corpus”; GUIDE §1; MUTATION “What is mutated”; `Float` |
| hole (of a context); `[·]`; `□` | The empty position in an evaluation context | [FIELD §1][F1]: Felleisen & Hieb; PFPL | — | standard | 01 §4.2; 03 “No use-after-move”; REDTEAM “Targets”; lean/README “What is mechanized”; GUIDE §1; MUTATION “The mutants”; TOOLING “What the review found”; `Syntax` |
...
| search; (Search) | The rule that finds the redex inside an evaluation context | [FIELD §1][F1]: PFPL §5.2 (search rules) | `Step` | standard | 01 §6.2; 03 “Lemmas §7 owes, and the …”; GUIDE “One program, traced both ways”; BRIDGE-SENSITIVITY “Distinct identities and two more …”; TOOLING “How it fits this package”; `Float` |
...
| frame (of a call) | One function activation: its environment and its stack of open scopes | [FIELD §1][F1]: `Frame` differs (PFPL's frame is a control-stack frame) | `Frame` | ours, pending audit | 01 §5.8; 03 “Type safety”; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “§6 step rows”; MUTATION “What is mutated”; `Statics` |
...
| scope record; scope records; `σ`; open scopes | Per frame, the list of cells each open scope must drop at its exit | none; FIELD §5 maps it to Rust's drop scope ([FIELD §5][F5]) | `Frame` | ours, pending audit | 01 §2; 03 intro; README “The extension rubric”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Distinct identities and two more …”; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
...
| fuel | A bound on how much work the interpreter may do; running out gives a timeout | [FIELD §3][F3]: Amin & Rompf | `eval` | standard | 01 §7; 03 intro; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY “Distinct identities and two more …”; MUTATION “What the proofs kill, and …”; CHECKER-PROFILE intro; `Dynamics` |
| out of fuel; `outOfFuel` | The interpreter's result when the fuel runs out | [FIELD §3][F3]: timeout | `EvalRes` | standard | 03 intro; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “Distinct identities and two more …”; `Dynamics` |
| definitional interpreter; `eval` | An interpreter that serves as the definition of the language | [FIELD §3][F3]: Amin & Rompf §2.1 | `eval`, `run` | standard | 01 §6; 03 intro; README “The executable oracle”; REDTEAM “Targets”; lean/README “Explaining a program”; GUIDE §2; BRIDGE-SENSITIVITY “Rule coverage”; MUTATION “What is mutated”; `Float` |
| executable; executable semantics; executable reference interpreter | A semantics that runs programs as well as defining them | [FIELD §7][F7]: executable model (Cedar) | `eval` | standard | 01 §5.4; README “The executable oracle”; WHAT-IT-MEANS “How this connects to the …”; lean/README “Deciding whether to believe it”; GUIDE §7; MUTATION “What the proofs kill, and …”; `Float` |
| monitor; monitors | A check `eval` adds that refuses a step §6 would take (`linearLeak`, `linearOverwrite`, `linearDiscard`, `ownedUnderCopy`) | [FIELD §6][F6]: "monitor" differs, partial | `Violation` | ours, pending audit | 03 “Type safety”; lean/README “Generated programs”; GUIDE §2; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; `Statics` |
...
| trap; traps; `↯κ`; trap on overflow | A defined run-time failure that halts the program with exit code 101 | [FIELD §1][F1]: checked error (PFPL §6.3), partial; [spec 8.1:1][s8.1] | `PanicKind` | Rue-specific, grounded | 01 §2; 03 intro; WHAT-IT-MEANS “What is proved”; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “Method”; MUTATION “What is mutated”; `Float` |
| panic; panics; `@panic` | A trap raised by the program, or any trap | [spec 1.4:18][s1], [4.13:5c][s4.13] | `PanicKind` | Rue-specific, grounded | 01 §2; 03 intro; README intro; WHAT-IT-MEANS “What is modelled”; lean/README “The bridge corpus”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “What the proofs kill, and …”; `Float` |
| result; outcome; exit code | What a finished run reports: exit status and output | [spec 6.1:8][s6.1] (exit code) | `EvalRes` | Rue-specific, grounded | 01 §2; 03 intro; README “The executable oracle”; WHAT-IT-MEANS “What is proved”; lean/README “The bridge corpus”; GUIDE §1; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE “The one exception: RUE-2346, already …”; TOOLING “Golf, on a scratch copy”; `Float` |
| observable; observable output; observe | What a run shows outside the process: `@dbg` output, destructor output, exit code | [FIELD §6][F6]: observable behavior (C11 §5.1.2.3¶6) | `Val.observable`, `Ty.observable` | standard | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “Method”; MUTATION intro; `Statics` |
...
| run | A whole evaluation of a program from its initial configuration | [FIELD §6][F6]: run (Leucker & Schallhart) | `run` | standard | 01 §1; 03 intro; README intro; WHAT-IT-MEANS “What is proved”; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE intro; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE intro; TOOLING “How it fits this package”; `Float` |
...
| once-through; counted (loop) | A generated loop that runs its body once, or counts a `mut` counter to a bound | none | — | ours, pending audit | 03 “No double-free”; REDTEAM “Roles”; lean/README “Generated programs”; GUIDE §4; BRIDGE-SENSITIVITY “Rule coverage”; MUTATION “Limits”; `Trace.Defs` |
| decode (of a dynamic tail); resolve | Turning a place's run-time indices into constant ones, by reading the indices | none | `Contents.resolveDyn` | ours, pending audit | 01 §5.8; TOOLING “Guardrails”; `Dynamics` |

### Drops, destructors and the store

| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| drop; dropped; dropped first | Running a value's destructor and then dropping its owned parts, when its owner goes out of scope or is overwritten | [FIELD §5][F5]: destructor; dropped (Rust Reference *Destructors*) | `dropCell`, `dropContents` | standard | 01 §2; 03 intro; README “The executable oracle”; WHAT-IT-MEANS “What is modelled”; REDTEAM “Targets”; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “Golf, on a scratch copy”; `Float` |
| destructor; user destructor; `drop fn` | A user-declared function that runs when a value of its type is dropped | [FIELD §5][F5]: Rust Reference *Destructors*; [spec 3.9:24][s3.9] | `StructDecl` | standard | 01 §3; 03 intro; WHAT-IT-MEANS “What is proved”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
...
| drop glue | The destructor, if any, then the drop of every owned field or element | [FIELD §5][F5]: rustc-dev-guide *Drop elaboration* | `dropContents` | standard | 01 §2; 03 “No double-free”; GUIDE “The run”; BRIDGE-SENSITIVITY “Results”; MUTATION “What is mutated”; `Statics` |
| drop order; ascending; ascending index order; declaration order (of drops) | Bindings drop newest first; a struct's fields in declaration order; an array's elements from first to last; an enum's active payload only | [FIELD §5][F5]: Rust Reference *Destructors* | `dropContents` | standard | 01 §2; 03 intro; WHAT-IT-MEANS “What is proved”; lean/README “Generated programs”; GUIDE “The three trace theorems, one …”; BRIDGE-SENSITIVITY “Method”; MUTATION “What the proofs kill, and …”; `Syntax` |
...
| allocation; allocation store; abstract allocations; `AllocId` | An abstract storage identity with its cells; the store maps each to its cells or to `†` | none | `Store` | ours, pending audit | 01 §2; 03 “No use-after-free”; README intro; GUIDE §2; `Dynamics` |
...
| registration stack | The machine's list, for every frame, of the pending `endscope` markers and the scope records | none | `Stk`, `Config.stack` | ours, pending audit | 03 “No use-after-drop / no leak …”; lean/README “Sharpness counter-examples”; GUIDE “The three trace theorems, one …”; `Trace.Defs` |
| scopes nest; nest | The pending `endscope` markers and the scope records agree, innermost first | none | `Nest`, `Config.Nested` | ours, pending audit | 01 §6.7; 03 “No use-after-drop / no leak …”; lean/README “Generated programs”; MUTATION “What the proofs kill, and …”; `Trace.Defs` |
| owned (node); own | Of an aggregate in a store: a non-`Copy` node whose identity the store owns | [FIELD §5][F5]: owner (Rust Book §4.1), partial | `Contents.own`, `storeOwn` | ours, pending audit | 01 §2; 03 intro; README “Why comptime is elaboration, not …”; REDTEAM intro; lean/README “The bridge corpus”; GUIDE intro; BRIDGE-SENSITIVITY “Method”; MUTATION intro; CHECKER-PROFILE intro; TOOLING intro; `Float` |

### Floating point

| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| datum; same datum | An abstract IEEE 754 value (a finite number, an infinity, or a NaN with a sign), not a bit pattern | [spec 3.12:1][s3.12] (the values of the format) | `FloatDatum` | Rue-specific, grounded | 01 §2; 03 “Lemmas §7 owes, and the …”; lean/README “Deciding whether to believe it”; GUIDE “The run”; MUTATION “RUE-2490's survivors”; `Float` |
...
| canonical | Of a finite datum's representation: the significand is odd or zero, so each number has exactly one | none | `canonNum`, `FloatDatum.Wf` | ours, pending audit | 01 §5.5; 03 intro; README “Contents”; REDTEAM “Roles”; lean/README “Sharpness counter-examples”; MUTATION “What is mutated”; `Float` |
| sign; sign bit; negative; positive | A float's sign, which a NaN also carries | [spec 3.12:24][s3.12], [3.12:44][s3.12] | `FloatDatum` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Deciding whether to believe it”; GUIDE “The run”; BRIDGE-SENSITIVITY “Results”; MUTATION “Mutation score”; `Float` |
| payload (of a NaN); sign and no payload; NaN payloads | The extra bits an IEEE NaN may carry; the model has none, since no Rue program can observe them | [spec 3.12:45][s3.12] | — | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §3; BRIDGE-SENSITIVITY “§6 step rows”; MUTATION “What is mutated”; CHECKER-PROFILE “Why a rejected program still …”; `Float` |
...
| subnormal | A finite float below the smallest normal magnitude, with reduced precision | [spec 3.12:10][s3.12] | `FloatWidth.eMin` | Rue-specific, grounded | lean/README “Sharpness counter-examples”; MUTATION “What is mutated”; `Float` |
| unordered | Of two floats: neither is less than, equal to, or greater than the other, because one is a NaN | [spec 3.12:27][s3.12] | `FloatDatum.lt` | Rue-specific, grounded | 01 §6.4; 03 “Lemmas §7 owes, and the …”; lean/README “Sharpness counter-examples”; GUIDE “What the checker demands”; MUTATION “The mutants”; `Float` |
...
| float model; `FloatModel`; interface | The rounded float operations, given as parameters with the laws IEEE 754 guarantees, rather than defined | none | `FloatModel`, `FloatOps` | ours, pending audit | 01 §6.4; 03 “Type safety”; README intro; lean/README “Deciding whether to believe it”; GUIDE §4; MUTATION “RUE-2490's survivors”; `Float` |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| theorem; theorems; proved; proved about | A statement with a kernel-checked proof | [FIELD §8][F8]: `theorem` vs `def` (Reference §7.4) | — | standard | 01 §2; 03 intro; README intro; WHAT-IT-MEANS intro; REDTEAM intro; lean/README intro; GUIDE intro; MUTATION intro; CHECKER-PROFILE intro; TOOLING “The module before”; `Float` |
| statement; statements | What a theorem asserts, read apart from its proof | none; FIELD §8: a theorem's type is a `Prop` (Reference §7.4) ([FIELD §8][F8]) | — | ours, pending audit | 01 §2; 03 “Type safety”; README intro; REDTEAM intro; lean/README intro; GUIDE “How to read this guide”; BRIDGE-SENSITIVITY “Distinct identities and two more …”; MUTATION intro; TOOLING “The workflows”; `Float` |
| claim; claim as a whole | Every headline statement together with the definitions they use, as the red team attacks them | none | — | ours, pending audit | 01 §2; 03 intro; README intro; WHAT-IT-MEANS “What is proved”; REDTEAM intro; lean/README “Generated programs”; GUIDE “One program, traced both ways”; MUTATION “The mutants”; `Dynamics` |
| definition; definitions; definitional | A `def`, `inductive` or `structure` a statement is written in; "definitional" of a fact that holds by unfolding one | [FIELD §8][F8]: `theorem` vs `def`; definitional equality (Reference §4) | — | standard | 01 §1; 03 intro; README intro; REDTEAM intro; lean/README “The bridge corpus”; GUIDE §2; MUTATION intro; TOOLING “The module before”; `Float` |
| type safety; the safety theorem; safety | Well-typed programs do not go wrong: progress and preservation together | [FIELD §2][F2]: PFPL Thm 6.1; TAPL §8.3 | `soundness`, `step_type_safety` | standard | 01 §1; 03 intro; README intro; lean/README intro; GUIDE §2; MUTATION “What the proofs kill, and …”; `Statics` |
| progress | A well-typed configuration is finished or can take a step | [FIELD §2][F2]: PFPL Thm 6.4 | `step_progress` | standard | 01 §6.4; 03 “Type safety”; README intro; lean/README “What is mechanized”; GUIDE §2; MUTATION “What is mutated”; `Float` |
| preservation | Each step keeps a configuration well-typed; ours is a semantic form (nothing reachable is stuck, halted values are typed) | [FIELD §2][F2]: PFPL Thm 6.2; `step_preservation` differs, partial | `step_preservation`, `Config.SafeAt` | ours, pending audit | 01 §6.4; 03 intro; lean/README “The proof map”; GUIDE §4; `Statics` |
| semantic; syntactic | Of typing or soundness: stated by what a program does, or by the typing rules alone | [FIELD §2][F2]: Timany §§2, 4 | `Config.SafeAt` | standard | 01 §2; 03 intro; lean/README “The statement layer”; GUIDE “How to read this guide”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “How it fits this package”; `Syntax` |
| soundness (of `eval`); sound | Every value and panic `eval` answers, §6's reduction also reaches | [FIELD §3][F3]: one direction of semantic equivalence (Amin & Rompf); FIELD's "differs" row for `eval_sound` | `eval_sound` | ours, pending audit | 01 §3; 03 intro; README “Why comptime is elaboration, not …”; WHAT-IT-MEANS “How we know the proofs …”; lean/README intro; GUIDE §2; MUTATION “What is mutated”; CHECKER-PROFILE intro; TOOLING “How it fits this package”; `Float` |
...
| adequacy; adequate | The agreement of `eval` with §6's small-step reduction, in both directions | [FIELD §3][F3]: "adequacy" differs, partial (accepted: semantic equivalence, Amin & Rompf) | `eval_sound`, `eval_complete` | ours, pending audit | 01 §6; 03 intro; lean/README “The bridge corpus”; GUIDE §2; MUTATION “What is mutated”; TOOLING “What the review found”; `Dynamics` |
| semantic equivalence; equivalence of big-step and small-step semantics | The agreement of a definitional interpreter (or a big-step semantics) with a small-step semantics, in both directions; the field's name for what our docs call adequacy | [FIELD §3][F3]: Amin & Rompf Thm 2; Leroy & Grall Thms 9, 11 | `eval_sound`, `eval_complete`, `eval_diverges_iff` | standard | lean/README “The statement layer” |
...
| `Matches`; `FrameMatches`; `ContentsMatches` | The invariant: each cell agrees with its binding's type and ownership state | [FIELD §2][F2]: "`Matches`" differs, partial | `Matches`, `FrameMatches`, `ContentsMatches` | ours, pending audit | 01 §5.5; 03 “Type safety”; WHAT-IT-MEANS “How we know the proofs …”; lean/README “How to read this, with …”; GUIDE §3; MUTATION “What is mutated”; `Syntax` |
...
| locality; `Untouched` | An evaluation grows the store and changes no cell outside its frame's own | none | `Untouched` | ours, pending audit | 01 §5.7; 03 “Type safety”; lean/README “How to read this, with …”; GUIDE §3; BRIDGE-SENSITIVITY “Distinct identities and two more …”; MUTATION “The mutants”; `Statics` |
...
| no double free; no double-free | No value is ended twice, and no destructor runs twice; over every run's trace so far (`step_no_double_free`), a finished run's (`no_double_free`) as a corollary | [FIELD §5][F5]: "No double-free" differs, partial (accepted: double free, CWE-415); a safety property ([FIELD §6][F6]) | `no_double_free`, `step_no_double_free` | ours, pending audit | 01 §7; 03 “No double-free”; lean/README “What is mechanized”; GUIDE §4 |
...
| witness | A concrete program, with a checked proof about it, that shows a theorem's case happening | [FIELD §7][F7]: interesting witness (Beer et al. §4.3 Def. 20), partial (theirs is a model or path) | — | ours, pending audit | 01 §8; REDTEAM intro; lean/README “The bridge corpus”; GUIDE “The three trace theorems, one …”; MUTATION “What is mutated”; `Float` |
| non-vacuity witness; non-vacuity witnesses | A statement, about a program or a model, showing every hypothesis of a theorem satisfiable at once, at an instance where its conclusion is not trivially true | [FIELD §7][F7]: "non-vacuity witness" differs, partial (accepted: interesting witness, Beer et al.) | — | ours, pending audit | REDTEAM intro; lean/README “Layers”; MUTATION “What is mutated” |
| sharpness counter-example; sharpness counter-examples; sharpness | A statement about a program (or configuration) of which one hypothesis of a theorem fails, every other holds, and the conclusion fails, so the hypothesis is needed; a theorem's sharpness is its having one for every hypothesis | [FIELD §7][F7]: "sharpness counter-example" differs, none (a counter-example proves non-validity, Beer et al. §4.3) | — | ours, pending audit | REDTEAM “Targets”; lean/README “Layers”; MUTATION intro |
| assumption; assumed; assumed, named; assumes | A fact a theorem takes as a hypothesis rather than proves | none | `FloatModel` | ours, pending audit | 01 §2; 03 “Lemmas §7 owes, and the …”; lean/README “Deciding whether to believe it”; GUIDE §4; TOOLING “How it fits this package”; `Float` |
| consequence; consequences of | A fact that follows from a rule or definition, as opposed to one stated separately | none | — | ours, pending audit | 01 §4.2; 03 “No use-after-drop / no leak …”; lean/README “Sharpness counter-examples”; GUIDE §4; `Float` |
| unprovable | Of a claim: it cannot be proved from the stated premises | none | — | ours, pending audit | 01 §7 |
| mutual recursion | Two or more definitions that refer to each other | [FIELD §8][F8]: `mutual` (Reference §7.6.1) | `Typed`, `TypedArgs`, `TypedArms` | standard | 01 §6.11 |

### Traces and monitors

| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| trace; drop trace; event | The sequence of observable events a run emits: `@dbg` lines, drops, destructor runs, consumptions | [FIELD §6][F6]: trace (Leucker & Schallhart), clear | `Event`, `EvalRes.trace`, `Config.trace` | standard | 01 §2; 03 intro; README “The executable oracle”; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY “Rule coverage”; MUTATION “What is mutated”; `Dynamics` |
| finished (run) | A run that halts normally or in a trap, rather than running out of fuel | none; FIELD §6 notes that properties of finished traces become ordinary trace properties by padding ([FIELD §6][F6]) | — | ours, pending audit | 03 “No double-free”; lean/README “Sharpness counter-examples”; GUIDE §2; MUTATION “What the proofs kill, and …”; `Dynamics` |
| trace property | A property of runs, stated over their traces | [FIELD §6][F6]: Clarkson & Schneider §2.1 | — | standard | — |
| safety property | Nothing bad happens: every violation shows in a finite prefix | [FIELD §6][F6]: Alpern & Schneider §2 | — | standard | MUTATION “The mutants” |
| `Blocks` | Every finished run's trace is in a grammar: each event that starts a value's drop is followed by exactly the events of that drop | [FIELD §6][F6]: `Blocks` differs, none | `Blocks` | ours, pending audit | 01 §6.13.3; 03 “No use-after-drop / no leak …”; README “The architecture: surface → elaboration …”; lean/README “Generated programs”; GUIDE “The three trace theorems, one …”; MUTATION “What is mutated”; TOOLING “The module before”; `Trace.Defs` |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| differential testing; differential-tested | Running the same inputs on comparable systems and treating a difference as a candidate bug | [FIELD §7][F7]: McKeeman 1998 | — | standard | 01 §6; REDTEAM “Targets”; lean/README “The main theorem” |
| oracle; differential-testing oracle; `rue-oracle` | The executable reference interpreter the compiler's output is compared against | [FIELD §7][F7]: "oracle" differs, partial (pseudo-oracle, Barr §5.1) | — | ours, pending audit | 01 §2; 03 intro; README intro; WHAT-IT-MEANS intro; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY “Method”; `Dynamics` |
| bridge; bridge corpus | The comparison of the compiler and the oracle against the Lean model's accept/reject decisions and interpreter outcomes | [FIELD §7][F7]: "bridge" differs, partial (accepted: differential testing against an executable model) | — | ours, pending audit | 01 §5.8; 03 intro; README “The executable oracle”; REDTEAM intro; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY intro; MUTATION intro; CHECKER-PROFILE intro; `Statics` |
| corpus | The saved set of test programs run against the compiler and the Lean model | [FIELD §7][F7]: corpus (libFuzzer; Cedar §4) | — | standard | 01 §6; 03 “No use-after-drop / no leak …”; README “The executable oracle”; WHAT-IT-MEANS “How this connects to the …”; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY intro; MUTATION “What is mutated”; CHECKER-PROFILE intro; `Float` |
| seed; seeds; seed cases; seed corpus | The hand-written corpus cases | [FIELD §7][F7]: "seed cases" differs, partial | — | ours, pending audit | 01 §6.4; 03 “Type safety”; lean/README “The bridge corpus”; GUIDE §4; BRIDGE-SENSITIVITY intro; MUTATION intro; CHECKER-PROFILE intro; `Checker.Defs` |
| seed (random); `--seed N` | The number that fixes a generated corpus | [FIELD §7][F7]: random seed (libFuzzer `-seed=N`; Csmith §3.4) | — | standard | 01 §6.4; 03 “Type safety”; lean/README “The bridge corpus”; GUIDE “Loops, briefly”; BRIDGE-SENSITIVITY intro; MUTATION “Method”; CHECKER-PROFILE intro; `Checker.Defs` |
| generated programs; `--gen N` | Corpus programs produced at random by `Gen.lean` | [FIELD §7][F7]: random program generation, clear | — | standard | lean/README “Generated programs”; BRIDGE-SENSITIVITY “Detection rate”; CHECKER-PROFILE intro |
| verdict | The checker's accept or reject on a corpus case | [FIELD §7][F7]: "verdict" differs, none | `checkProgram` | ours, pending audit | 03 “Lemmas §7 owes, and the …”; README “The executable oracle”; WHAT-IT-MEANS “How this connects to the …”; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE §4; BRIDGE-SENSITIVITY “Rule coverage”; MUTATION “Method”; CHECKER-PROFILE “Why a rejected program still …”; `Checker.Defs` |
| red case; disagreement | A corpus case on which two of the compared systems disagree | [FIELD §7][F7]: "red case" differs, partial | — | ours, pending audit | 01 §5.5; 03 “Type safety”; README intro; WHAT-IT-MEANS intro; lean/README “The bridge corpus”; GUIDE “One program, traced both ways”; BRIDGE-SENSITIVITY “Method”; MUTATION “What is mutated”; CHECKER-PROFILE intro; `Statics` |
...
| model; model choice; model choices | The Lean definitions as an executable model; a choice the model fixes where the specification leaves one open | [FIELD §7][F7]: executable model (Cedar); "model choice" none | — | ours, pending audit | 01 §2; 03 “Type safety”; README “The executable oracle”; WHAT-IT-MEANS intro; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY intro; CHECKER-PROFILE intro; `Float` |
| mutation; mutant; mutants; killed; survived; equivalent mutant; equivalent (mutant); mutation score; mutation analysis | Changing a definition or program slightly and checking that some test notices: a mutant is killed when a test's result differs; one no test can kill is equivalent; the score is killed over non-equivalent | [FIELD §7][F7]: DeMillo, Lipton & Sayward 1978; Jia & Harman §II.B | — | standard | 01 §5; 03 “Exclusivity / no aliased mutation”; README “Contents”; REDTEAM intro; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY intro; MUTATION intro; `Statics` |
| caught | Of a re-introduced historical compiler bug: some corpus case notices it | [FIELD §7][F7]: "caught" differs, partial (accepted: killed) | — | ours, pending audit | 01 §5; README “The executable oracle”; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE §7; BRIDGE-SENSITIVITY intro; MUTATION “What is mutated”; `Dynamics` |
...
| sensitivity (of the bridge) | The share of re-introduced compiler bugs and mutants that some corpus case catches | none; the nearest accepted measure is the mutation score ([FIELD §7][F7]) | — | ours, pending audit | REDTEAM intro; lean/README “The bridge corpus”; BRIDGE-SENSITIVITY intro; MUTATION intro |
| every statement holds; only a helper is false; a stated property is false; helper lemma only; proof script only | The reading of a definition mutant against the stated properties (the Spec statements and the theorems linking them): none is false; only a lemma that restates a definition is false; or a stated property is false. Only the last counts as a kill by a proof; a proof that fails while every statement holds failed as a script | none; the nearest accepted term is "killed" ([FIELD §7][F7]), which these readings refine for a proof that fails | — | ours, pending audit | MUTATION “Reading a proof failure” |
| spec pass; mutation target; mutation targets; candidate statement; candidate statements; unproved; unproved candidate | The pass of `mutate.py` that reads the statements under a mutant: its mutation targets are the definitions the mutant edits; a candidate statement is one in which a target occurs where the mutant can make it false (in a hypothesis or under `¬` for a weakening, in a conclusion for a strengthening, anywhere in a term or an `↔`); a candidate is unproved when its proof rests on a proof that fails under the mutant | none; polarity is the logician's positive and negative occurrence | — | ours, pending audit | MUTATION intro; `Float` |
| Explain mirror | `Explain.lean`'s explainer and trace, second copies of `check` and `eval` proved equal to them (`explain_result`, `traceEval_res`, both in L3); a mutant that changes one copy fails that proof whatever the change means, so the failure is not counted as a kill | none | — | ours, pending audit | MUTATION “Method” |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| verified | Of a compiler or validator: proved correct against a specification (Leroy); the docs never use this sense of the checker or the interpreter — the checker is proved sound only, and `eval` is proved adequate to §6's `Step` (`eval_sound`, `eval_complete`), not itself the specification. Where the docs use "verified", it means confirmed against the compiler, confirmed by hand, or kernel-checked | [FIELD §7][F7]: verified compiler, verified validator (Leroy CACM §2.2) | — | standard | 01 §2; 03 “Linear values are consumed exactly …”; WHAT-IT-MEANS “What that does and does …”; lean/README “What is mechanized”; GUIDE §6; BRIDGE-SENSITIVITY “Results”; TOOLING “Guardrails”; `Float` |
| kernel; kernel-checked | Lean's small type checker, which re-checks every proof | [FIELD §8][F8]: Reference §2 | — | standard | 03 intro; README intro; WHAT-IT-MEANS “How we know the proofs …”; lean/README “Deciding whether to believe it”; GUIDE “The one edge no monitor …”; MUTATION intro; TOOLING “What we decline, and why”; `Float` |
| axiom | A constant assumed without proof | [FIELD §8][F8]: Reference §8 | — | standard | 03 “Lemmas §7 owes, and the …”; REDTEAM “Targets”; lean/README “Building”; GUIDE “What the proof needs”; MUTATION “Method”; TOOLING intro; `Float` |
| `sorry` | A placeholder that closes any goal by the axiom `sorryAx` | [FIELD §8][F8]: Reference §8.4 | — | standard | REDTEAM “Targets”; lean/README intro; GUIDE §7; MUTATION “Method”; TOOLING “The workflows” |
...
| Lean Comparator; Comparator | A tool that checks proofs against a trusted file of statements, replaying them through the kernel, and checks the proved statements match | [FIELD §8][F8]: comparator | — | standard | REDTEAM “Targets”; lean/README “The statement layer”; TOOLING intro |
...
| inductive type; inductive; inductively defined proposition | A type, or a relation in `Prop`, given by its constructors | [FIELD §8][F8]: TPIL §7.3 | `Typed`, `Step` | standard | lean/README “How to read this, with …”; GUIDE §1; MUTATION “What is mutated”; `Syntax` |
...
| module; `module` system | A Lean source file, and Lean's module system that controls what one exposes | [FIELD §8][F8]: Reference §§5.3–5.4 | — | standard | 01 §2; lean/README “Building”; GUIDE §2; BRIDGE-SENSITIVITY “Distinct identities and two more …”; MUTATION “Method”; CHECKER-PROFILE “Why a rejected program still …”; TOOLING intro; `Float` |
| L0 syntax; L1 definitions; L2 proofs; L3 tooling; layer | The four layers of the package, each importing only its own or lower ones | none | — | ours, pending audit | 01 §6.13.3; README “Why comptime is elaboration, not …”; REDTEAM intro; lean/README “Deciding whether to believe it”; GUIDE §6; BRIDGE-SENSITIVITY “Distinct identities and two more …”; MUTATION “What is mutated”; TOOLING “How it fits this package”; `Float` |
| statement layer; spine; Spec statements | The planned layer of headline statements apart from proofs; the chain of theorems the main claim rests on | none | — | ours, pending audit | REDTEAM intro; lean/README “Deciding whether to believe it”; GUIDE §6; MUTATION “What is mutated”; TOOLING “The workflows” |
...
| proof map | The generated `MAP.md`: Mermaid diagrams of the spine and the milestones, the edges between them, what each spine theorem's statement depends on, and the static assurance chain | none | — | ours, pending audit | lean/README “Layers” |
...
| explain rendering; explain | The generated per-case trace of a corpus program under the model | none | — | ours, pending audit | 03 “No use-after-drop / no leak …”; lean/README “Explaining a program”; GUIDE “One program, traced both ways”; BRIDGE-SENSITIVITY “Rule coverage”; MUTATION “Method”; CHECKER-PROFILE intro; `Dynamics` |
...
| adjudicator; counts; counted (finding) | The coordinator who decides which findings stand; a finding counts once reproduced or independently found twice | none | — | ours, pending audit | 03 “No double-free”; REDTEAM intro; lean/README “Generated programs”; GUIDE §4; BRIDGE-SENSITIVITY “Method”; MUTATION “Method”; CHECKER-PROFILE intro; TOOLING “What the review found”; `Syntax` |
...
| change | One lane's diff, what per-lane review attacks, as opposed to the whole claim | none | — | ours, pending audit | 01 §2; README “Relationship to the prose spec”; REDTEAM intro; lean/README “Generated programs”; GUIDE “The three trace theorems, one …”; BRIDGE-SENSITIVITY “Observable destructors”; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “The workflows”; `Dynamics` |
| docs (target); definitions (target); statements (target); bridge (target) | The five red-team targets: statements, definitions, the compiler-against-model comparison, docs, trusted base | none | — | ours, pending audit | 01 §1; 03 intro; README intro; REDTEAM intro; lean/README intro; GUIDE §2; BRIDGE-SENSITIVITY intro; MUTATION intro; CHECKER-PROFILE intro; TOOLING “How it fits this package”; `Float` |
...
| absorbs | Of the join: joining a second copy of one argument changes nothing, `join(join(a, b), b) = join(a, b)` | none; lattice absorption is a different law, `a ⊔ (a ⊓ b) = a` | `Ctx.join` | ours, pending audit | 03 “Lemmas §7 owes, and the …”; GUIDE §2; `Dynamics` |
| relation; partial equivalence relation | A set of pairs; one that is symmetric and transitive but need not be reflexive | none fetched | — | ours, pending audit | 01 §2; 03 intro; REDTEAM “Targets”; lean/README “Sharpness counter-examples”; GUIDE intro; MUTATION “What is mutated”; `Statics` |
...
| prefix; proper prefix; longest proper prefix | An initial part of a sequence; one shorter than the whole; the longest such with a given property | [FIELD §6][F6]: prefix (Alpern & Schneider) | — | standard | 01 §4.2; 03 intro; lean/README “Generated programs”; GUIDE §1; TOOLING “Guardrails”; `Syntax` |
...
| tree | A structure in which each node has a list of children; a cell's contents are one | [FIELD §5][F5]: move paths form a tree (rustc-dev-guide) | `Contents` | standard | 01 §5; 03 intro; REDTEAM “Roles”; lean/README “Explaining a program”; GUIDE §2; TOOLING “How it fits this package”; `Syntax` |
| stack | A list used last in, first out | [FIELD §1][F1]: control stack | `Stk` | standard | 01 §6.1; 03 “Type safety”; lean/README “How to read this, with …”; GUIDE §2; MUTATION “The mutants”; `Dynamics` |
| shape; shapes | Of a state or declaration environment: its structure with the particular values left out | none | `Contents.skeleton`, `Ctx.SameSkel` | ours, pending audit | 01 §5; 03 intro; README intro; WHAT-IT-MEANS “What that does and does …”; lean/README intro; GUIDE intro; BRIDGE-SENSITIVITY “Method”; MUTATION “What the proofs kill, and …”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
...
| `↔`; `⟺` | "if and only if"; "to and from" | Logical equivalence; in prose, a conversion both ways (float↔integer) | Lean's `↔` (TPIL, [FIELD §8][F8]) | none | 01 §2; lean/README “Sharpness counter-examples”; MUTATION “Method”; `Statics` |
| `⟹` | "implies" | Implication, in the float rule tables | Ordinary logic notation | none | 01 §6.4 |
| `¬`; `∧`; `∨`; `∀`; `∃` | "not", "and", "or", "for all", "there exists" | Logical connectives and quantifiers | Lean's notation for propositions ([FIELD §8][F8]) | none | 01 §5; 03 “Type safety”; lean/README “Non-vacuity witnesses”; GUIDE §4; MUTATION “Method”; `Float` |
| `∈`; `∉`; `∋`; `∅`; `∪`; `⊂`; `⊆`; `⊊` | "in", "not in", "contains", "empty", "union", "proper subset", "subset", "proper subset" | Set membership and inclusion; `∅` also the empty mutability mark and the empty loan set; `⊊` in `check ⊊ Typed`, "strictly fewer programs than" | Ordinary set notation | none | 01 §2; 03 intro; GUIDE “The three trace theorems, one …”; `Float` |
| `≠`; `≤`; `≥`; `−`; `±`; `×`; `·` | "not equal", "at most", "at least", "minus", "plus or minus", "times" / "product", "times" / "then" | Arithmetic and comparison; `×` also a pair type; `·` also stack push, `ret(E, φ) · K` | Ordinary notation | none | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Follow-ups”; MUTATION “What is mutated”; `Float` |
...
| `FloatDatum` | `Float` | An abstract IEEE 754 value, not a bit pattern: a signed finite number `sig · 2^exp`, a signed infinity, or a signed NaN with no payload (§2) | Rue-specific, grounded (spec 3.12:1) | MUTATION “RUE-2490's survivors”; `Float` |
...
| `FloatDatum.Wf` | `Float` | A float value is canonical and, when finite, representable at the given width | ours, pending audit | lean/README “Sharpness counter-examples”; MUTATION “What is mutated” |
...
| `FloatModel` | `Float` | The float operations together with the laws §7 needs of them (closure, totality), each true of IEEE 754 | ours, pending audit | 03 “Type safety”; README intro; lean/README “Deciding whether to believe it”; GUIDE “What the proof needs”; MUTATION “RUE-2490's survivors”; `Float` |
...
| `Mult.join` | `Syntax` | The least upper bound `⊔` of two classes | standard (FIELD §9: join, Tarski 1955 §1; FIELD §4: `⊔`, Tov & Pucella) | MUTATION “What is mutated” |
...
| `InBounds` | `Syntax` | An integer lies in its type's range; arithmetic outside it traps rather than wraps (`3.1:6`) | Rue-specific, grounded (spec 3.1:6) | lean/README “Deciding whether to believe it”; MUTATION “What is mutated”; `Float` |
...
| `Ty.mult` | `Syntax` | A type's class, `class(T)` (§3): scalars are `Copy`, arrays take their element's, declarations their recorded class | Rue-specific, grounded (spec 6.3:19) | lean/README “Deciding whether to believe it”; GUIDE §7; MUTATION “What is mutated”; `Syntax` |
...
| `Ty.atPath` | `Syntax` | The type a path of projections reaches from a given type, if every step is valid (`Γ ⊢ p : T`) | standard (FIELD §5: path) | MUTATION “What is mutated”; `Syntax` |
...
| `linearResidue` | `Syntax` | Whether the fields a declared-linear destructure leaves unselected carry a linear value (§5.1's `linear-residue`) | Rue-specific, grounded (spec 3.8:60) | lean/README “What is mechanized”; GUIDE “What the checker demands”; MUTATION “What is mutated”; `Syntax` |
...
| `Expr.breaks` | `Syntax` | An expression contains a `break` targeting the enclosing loop, not one inside a nested loop (`4.8:21`) | Rue-specific, grounded (spec 4.8:21) | MUTATION “What is mutated”; `Syntax` |
...
| `OwnSt.setField` | `Statics` | Writes one field's state | helper | — |
...
| `residualLinear` | `Statics` | Whether what is still owned at a path carries a linear value (§5.6) | ours, pending audit | 03 “Linear values are consumed exactly …”; lean/README “What is mechanized”; GUIDE “What the checker demands”; MUTATION “What is mutated”; `Syntax` |
...
| `assignArrayOk` | `Statics` | An assignment into an array needs the whole array owned, with no element moved out (`3.8:72`, E0480) | Rue-specific, grounded (spec 3.8:72) | 03 intro; GUIDE “What the checker demands”; MUTATION “The mutants”; `Syntax` |
...
| `Entry.setSt` | `Statics` | Replaces an entry's ownership state | helper | — |
...
| `fnCtx` | `Statics` | A function body's starting context: every by-value parameter owned (§5.8's (Fn)) | standard (FIELD §4: typing context) | MUTATION “What is mutated”; `Syntax` |
...
| `Typed` | `Statics` | The typing judgment `Γ ; Σ ⊢ e ⇒ T ⊣ Ω` of §5: one constructor per typing rule | standard (FIELD §2: typing judgment `Γ ⊢ e : τ`) | 03 “Type safety”; REDTEAM “Targets”; lean/README “How to read this, with …”; GUIDE §1; MUTATION “What is mutated”; CHECKER-PROFILE intro; `Syntax` |
...
| `TypedArms` | `Statics` | Typing of a `match`'s arms, each from the same starting state and at one type (§5.5) | standard (FIELD §2: typing judgment) | MUTATION “The mutants”; `Statics` |
...
| `WfProgram` | `Statics` | A program is well formed: its declarations and every function | standard (FIELD §9: well-formed, PFPL §1.2) | lean/README “Sharpness counter-examples” |
| `ProgramTyped` | `Statics` | A program ready to run: well formed, with an entry function that takes no parameters (§6.12) | standard (FIELD §2: typing judgment) | 03 “Type safety”; lean/README “Non-vacuity witnesses”; GUIDE §4; MUTATION “The mutants” |
...
| `introVal` | `Dynamics` | Builds an aggregate value (struct, array, enum) and gives it a fresh identity, the next store index | ours, pending audit | 03 “No double-free”; MUTATION “The mutants”; `Dynamics` |
| `eval` | `Dynamics` | The interpreter: runs an expression with a fuel bound, over a float model, to an `EvalRes` | standard (FIELD §3: definitional interpreter) | 03 intro; README “The executable oracle”; REDTEAM “Targets”; lean/README “Explaining a program”; GUIDE §2; BRIDGE-SENSITIVITY “Rule coverage”; MUTATION “What is mutated”; `Statics` |
| `run` | `Dynamics` | A program's outcome (§6.12): calls the entry function with no arguments in an empty store | ours, pending audit | 01 §6.9; 03 “Type safety”; lean/README “Explaining a program”; GUIDE §2; BRIDGE-SENSITIVITY “Distinct identities and two more …”; CHECKER-PROFILE intro; `Dynamics` |
...
| `Config.init` | `Step` | §6.12's initial configuration: empty store, empty frame, the entry function called with no arguments | standard (FIELD §1: configuration) | 03 “No use-after-drop / no leak …”; lean/README “Non-vacuity witnesses”; GUIDE §2; MUTATION “The mutants”; `Step` |
...
| `Step` | `Step` | §6's reduction relation `C → C′`: one constructor per §6 rule, plus the search rules of §6.2 | standard (FIELD §1: small-step transition relation) | 03 intro; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE §2; MUTATION “What is mutated”; TOOLING “Golf, on a scratch copy”; `Dynamics` |
| `Steps` | `Step` | `→*` (§6.12): the reflexive-transitive closure of `Step` | standard (FIELD §1: `→*` reflexive-transitive closure) | lean/README “Sharpness counter-examples”; TOOLING “Golf, on a scratch copy” |
...
| `stepRet` | `Step` | `step` when a value returns into the top frame | helper | — |
| `step` | `Step` | `Step` as a function: the one step a configuration takes, or why it takes none (halted or stuck) | standard (FIELD §1: small-step transition relation) | 03 “Lemmas §7 owes, and the …”; lean/README “Sharpness counter-examples”; MUTATION “What is mutated”; `Step` |
| `Config.Stuck` | `Step` | A stuck configuration (§6, §7): not final, and no §6 rule applies | standard (FIELD §1: stuck) | — |
...
| `stepN` | `Step` | Takes up to `n` steps, stopping early | helper | lean/README “What is mechanized”; GUIDE §2; MUTATION “What the proofs kill, and …” |
| `letAddProgram` | `Step` | Demo program `let x = 40; x + 2` | helper | — |
| `demoDecls` | `Step` | Demo declarations: an affine struct with a destructor and an enum carrying it | helper | — |
...
| `headIter` | `Checker.Defs` | §5.7's loop-head iteration, up to `n` rounds, to the first unchanged state | helper | 03 “Lemmas §7 owes, and the …”; lean/README “What is mechanized”; GUIDE “Loops, briefly”; MUTATION “The mutants”; `Checker.Defs` |
...
| `ContentsMatches` | `Soundness.Defs` | Node-by-node agreement between the ownership state for a path and what is stored there | ours, pending audit | 03 “Type safety”; lean/README “The main theorem”; GUIDE §3; MUTATION “What is mutated”; `Syntax` |
...
| `FrameMatches` | `Soundness.Defs` | The per-frame invariant: context agrees with the store, and the frame's drop list is its environment | ours, pending audit | 03 “Type safety”; lean/README “How to read this, with …”; GUIDE §3; MUTATION “What is mutated”; `Soundness.Defs` |
...
| `EvalOk` | `Soundness.Defs` | What the soundness theorem promises about `eval`'s result: a well-typed value with the invariant restored, or an allowed abort | ours, pending audit | lean/README “What is mechanized”; GUIDE §4; MUTATION “What is mutated”; `Soundness.Defs` |
...
| `Exact` | `Trace.Defs` | For one evaluation: each starting identity is accounted for exactly once, in the result or among what the trace freed | ours, pending audit | 03 “No use-after-drop / no leak …”; lean/README “Sharpness counter-examples”; GUIDE “The three trace theorems, one …”; MUTATION “What is mutated”; `Trace.Defs` |
...
| `Local` | `Trace.Defs` | The store only grew, and cells outside the frame's environment were left alone or marked dead | helper | BRIDGE-SENSITIVITY “Observable destructors” |
...
| `GlueBlocks` | `Trace.Defs` | `Blocks` with each drop's events given by `DropGlue` rather than by `dropEvents`: §6.11's drop order as a grammar over traces, in §6.11's own terms | ours, pending audit | lean/README “Sharpness counter-examples”; GUIDE “The three trace theorems, one …”; MUTATION “What the proofs kill, and …” |
...
| `NewestFirst` | `Trace.Defs` | One step's drops name one cell, or distinct cells in strictly decreasing location order | ours, pending audit | 03 “No use-after-drop / no leak …”; lean/README “What is mechanized”; GUIDE “The three trace theorems, one …”; MUTATION “What is mutated”; `Trace.Defs` |
...
| `ArgsTag.own` | `Trace.Defs` | The owned identities a list context's tag holds: an indexed assignment's right-hand side | helper | lean/README “What is mechanized” |
...
- Against the literature (RUE-2467); New here; tested; tested, not proved; They never get stuck; verification-guided development; The axiom trace; Candidates, by polarity; The completeness mutants; The spec pass (RUE-2499); Everything imports the proofs; Not mutated; Reproduce; Time; Two further passes; What counts as killed; With the proofs off; In RUE-2241's Linux lane; The lint; On macOS; Read the claim; Running Comparator; unsandboxed and says nothing; `3.0:5` (E0483), mechanized; A `@panic` (by design); Accessor calls
  (ADR-0062); What a configuration holds; Across cells; argument's syntax alone; Array construction; The

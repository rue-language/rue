...
| mutable; `mut`; unmarked | Of a place: it may be assigned, because its root is a `mut` binding or an `inout` parameter | [spec 6.1:43][s6.1] | — | Rue-specific, grounded | 01 §2; lean/README “Generated programs”; GUIDE §5; BRIDGE-SENSITIVITY “Observable destructors”; MUTATION “Reading a proof failure”; `Syntax` |

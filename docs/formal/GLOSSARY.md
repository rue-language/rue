...
| semantic; syntactic | Of typing or soundness: stated by what a program does, or by the typing rules alone | [FIELD §2][F2]: Timany §§2, 4 | `Config.SafeAt` | standard | 01 §2; 03 intro; lean/README “What is mechanized”; GUIDE “How to read this guide”; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
...
| proof map | The generated `MAP.md`: Mermaid diagrams of the spine and the milestones, the edges between them, what each spine theorem's statement depends on, and the static assurance chain | none | — | ours, pending audit | lean/README “The proof map” |

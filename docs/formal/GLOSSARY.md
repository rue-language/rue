...
| relation; partial equivalence relation | A set of pairs; one that is symmetric and transitive but need not be reflexive | none fetched | — | ours, pending audit | 01 §2; 03 intro; REDTEAM “Targets”; lean/README “What is mechanized”; GUIDE intro; MUTATION “What is mutated”; `Statics` |
...
| `step` | `Step` | `Step` as a function: the one step a configuration takes, or why it takes none (halted or stuck) | standard (FIELD §1: small-step transition relation) | 03 “Lemmas §7 owes, and the …”; lean/README “What is mechanized”; MUTATION “What is mutated”; `Step` |
...
| `Exact` | `Trace.Defs` | For one evaluation: each starting identity is accounted for exactly once, in the result or among what the trace freed | ours, pending audit | 03 “No use-after-drop / no leak …”; lean/README “What is mechanized”; GUIDE “The three trace theorems, one …”; MUTATION “What is mutated”; `Trace.Defs` |

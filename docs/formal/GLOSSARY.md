...
| library; library obligations; library bug | The trusted standard-library code behind the buffer-backed containers, the conditions (§6.13.5) it must meet, and a violation of them | none | — | ours, pending audit | 01 §2; README “Contents”; lean/README “Deciding whether to believe it” |
...
| MUST NOT; MUST | A requirement level: an absolute prohibition, an absolute requirement | [FIELD §7][F7]: RFC 2119 §§1–2; [spec 1.4:3][s1] | — | standard | 01 §2; 03 “Linear values are consumed exactly …”; README intro; REDTEAM “Roles”; lean/README “Generated programs”; GUIDE “Fuel, and why the theorems …”; BRIDGE-SENSITIVITY “Method”; MUTATION “RUE-2490: the statement vocabulary and …”; `Float` |
...
| value; values; on values | A finished result of evaluation, which takes no step | [FIELD §1][F1]: PFPL §5.2 (`e val`) | `Val` | standard | 01 §2; 03 intro; README “Contents”; lean/README “The bridge corpus”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION “The mutants”; CHECKER-PROFILE intro; `Float` |
...
| float; float(w) | The IEEE 754 binary32 and binary64 types, `f32` and `f64` | [spec 3.12:1][s3.12] | `FloatWidth` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION intro; `Float` |
...
| never; never type | The type `!` of an expression that transfers control away and yields no value | [spec 3.4:1][s3.4] | — | Rue-specific, grounded | 01 §2; 03 intro; README “Relationship to the prose spec”; REDTEAM “Roles”; lean/README “The bridge corpus”; GUIDE intro; BRIDGE-SENSITIVITY “Results”; MUTATION intro; CHECKER-PROFILE intro; `Float` |
...
| struct; structs | A user-declared record type with named fields | [spec 6.2:1][s6.2] | `StructDecl` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Generated programs”; GUIDE §2; BRIDGE-SENSITIVITY “Results”; MUTATION intro; `Syntax` |
...
| `Copy` | The class whose values may be used any number of times and dropped | [spec 3.8:2][s3.8]; FIELD §4: "unrestricted" (Walker), partial | `Mult.copy` | Rue-specific, grounded | 01 §2; 03 intro; README “The extension rubric”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “§5 derivation nodes”; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
...
| infectious; infectiousness; by infection; lifting | A struct takes at least the class of its most restrictive field | [spec 3.8:58][s3.8] ("linearity is infectious"); FIELD §4 differs, partial | `Attr.lift` | Rue-specific, grounded | 01 §3; 03 “Linear values are consumed exactly …”; MUTATION “The mutants”; `Syntax` |
...
| declared-linear; declared | Of a struct: marked `linear` itself, not linear only by infection | [spec 3.8:30][s3.8], [3.8:33][s3.8] | `Ty.declaredLinear` | Rue-specific, grounded | 01 §3; 03 intro; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
...
| copies; copy | A use that duplicates a `Copy` value and leaves its place as it was | [spec 3.8:1][s3.8] | — | Rue-specific, grounded | 01 §2; 03 intro; README “The extension rubric”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY intro; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; `Syntax` |
...
| partial move; partial; element-wise partial move | A move of one field or constant-index element, leaving its siblings in place | [FIELD §5][F5]: Rust Reference *Patterns*, *Destructors* | `OwnSt.fields` | standard | 01 §2; 03 intro; README “Why comptime is elaboration, not …”; lean/README “The trusted-base lint”; GUIDE §2; BRIDGE-SENSITIVITY “Results”; MUTATION “The mutants”; `Syntax` |
...
| well-typed | Of a program or expression: some typing derivation exists for it | [FIELD §2][F2]: PFPL Thm 6.4 (progress, for well-typed terms) | `HasTy` | standard | 01 §6.1; 03 intro; lean/README “How to read this, with …”; GUIDE §1; MUTATION “The mutants”; `Float` |
...
| configuration; initial configuration | The machine's whole state: store, frame, control stack and focus, or a halted result | [FIELD §1][F1]: Plotkin §1.2 (transition system; configuration) | `Config`, `Config.init` | standard | 01 §6.1; 03 intro; README “The extension rubric”; REDTEAM “Targets”; lean/README “Layers”; GUIDE §2; MUTATION “RUE-2490: the statement vocabulary and …”; `Dynamics` |
| terminal | Of a configuration: finished, a value returned to the bottom of the stack or a trap | [FIELD §1][F1]: Plotkin §1.2 Def. 2 (terminal transition system) | `Config.Terminal` | standard | 03 “No use-after-drop / no leak …”; lean/README “What is mechanized”; GUIDE §2; MUTATION “RUE-2490: the statement vocabulary and …”; `Step` |
...
| environment; `ρ` | The map from each binding in scope to its cell and path | [FIELD §3][F3]: environment (Amin & Rompf §§2.1–2.2); `eval n ρ e` | `Env` | standard | 01 §2; 03 “Type safety”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Multi-function programs”; `Syntax` |
...
| once-through; counted (loop) | A generated loop that runs its body once, or counts a `mut` counter to a bound | none | — | ours, pending audit | 03 “No double-free”; REDTEAM “Roles”; lean/README “Generated programs”; GUIDE §4; BRIDGE-SENSITIVITY “Rule coverage”; MUTATION “Mutation score”; `Trace.Defs` |
...
| registration stack | The machine's list, for every frame, of the pending `endscope` markers and the scope records | none | `Stk`, `Config.stack` | ours, pending audit | 03 “No use-after-drop / no leak …”; lean/README “Sharpness counter-examples”; GUIDE “The three trace theorems, one …”; MUTATION “RUE-2490: the statement vocabulary and …”; `Trace.Defs` |
...
| sign; sign bit; negative; positive | A float's sign, which a NaN also carries | [spec 3.12:24][s3.12], [3.12:44][s3.12] | `FloatDatum` | Rue-specific, grounded | 01 §2; 03 intro; lean/README “Deciding whether to believe it”; GUIDE “The run”; BRIDGE-SENSITIVITY “Results”; MUTATION “What the proofs kill, and …”; `Float` |
...
| unordered | Of two floats: neither is less than, equal to, or greater than the other, because one is a NaN | [spec 3.12:27][s3.12] | `FloatDatum.lt` | Rue-specific, grounded | 01 §6.4; 03 “Lemmas §7 owes, and the …”; lean/README “Sharpness counter-examples”; GUIDE “What the checker demands”; MUTATION “RUE-2490: the statement vocabulary and …”; `Float` |
...
| claim; claim as a whole | Every headline statement together with the definitions they use, as the red team attacks them | none | — | ours, pending audit | 01 §2; 03 intro; README intro; REDTEAM intro; lean/README “Explaining a program”; GUIDE “One program, traced both ways”; MUTATION “RUE-2490: the statement vocabulary and …”; `Dynamics` |
...
| preservation | Each step keeps a configuration well-typed; ours is a semantic form (nothing reachable is stuck, halted values are typed) | [FIELD §2][F2]: PFPL Thm 6.2; `step_preservation` differs, partial | `step_preservation`, `Config.SafeAt` | ours, pending audit | 01 §6.4; 03 intro; lean/README “The proof map”; GUIDE §4; MUTATION “RUE-2490: the statement vocabulary and …”; `Statics` |
...
| soundness (of `eval`); sound | Every value and panic `eval` answers, §6's reduction also reaches | [FIELD §3][F3]: one direction of semantic equivalence (Amin & Rompf); FIELD's "differs" row for `eval_sound` | `eval_sound` | ours, pending audit | 01 §3; 03 intro; README “Why comptime is elaboration, not …”; lean/README intro; GUIDE §2; MUTATION intro; CHECKER-PROFILE intro; `Float` |
...
| adequacy; adequate | The agreement of `eval` with §6's small-step reduction, in both directions | [FIELD §3][F3]: "adequacy" differs, partial (accepted: semantic equivalence, Amin & Rompf) | `eval_sound`, `eval_complete` | ours, pending audit | 01 §6; 03 intro; lean/README “The bridge corpus”; GUIDE §2; MUTATION intro; `Dynamics` |
...
| `Matches`; `FrameMatches`; `ContentsMatches` | The invariant: each cell agrees with its binding's type and ownership state | [FIELD §2][F2]: "`Matches`" differs, partial | `Matches`, `FrameMatches`, `ContentsMatches` | ours, pending audit | 01 §5.5; 03 “Type safety”; lean/README “How to read this, with …”; GUIDE §3; MUTATION intro; `Syntax` |
...
| seed (random); `--seed N` | The number that fixes a generated corpus | [FIELD §7][F7]: random seed (libFuzzer `-seed=N`; Csmith §3.4) | — | standard | 01 §6.4; 03 “Type safety”; lean/README “The bridge corpus”; GUIDE “Loops, briefly”; BRIDGE-SENSITIVITY intro; MUTATION intro; CHECKER-PROFILE intro; `Checker.Defs` |
...
| axiom | A constant assumed without proof | [FIELD §8][F8]: Reference §8 | — | standard | 03 “Lemmas §7 owes, and the …”; REDTEAM “Targets”; lean/README “Deciding whether to believe it”; GUIDE “What the proof needs”; MUTATION “Proposed issues”; `Float` |
...
| L0 syntax; L1 definitions; L2 proofs; L3 tooling; layer | The four layers of the package, each importing only its own or lower ones | none | — | ours, pending audit | 01 §6.13.3; README “Why comptime is elaboration, not …”; REDTEAM intro; lean/README “Deciding whether to believe it”; GUIDE §6; MUTATION intro; `Float` |
...
| `↔`; `⟺` | "if and only if"; "to and from" | Logical equivalence; in prose, a conversion both ways (float↔integer) | Lean's `↔` (TPIL, [FIELD §8][F8]) | none | 01 §2; lean/README “Sharpness counter-examples”; MUTATION “Proposed issues”; `Statics` |
| `⟹` | "implies" | Implication, in the float rule tables | Ordinary logic notation | none | 01 §6.4 |
| `¬`; `∧`; `∨`; `∀`; `∃` | "not", "and", "or", "for all", "there exists" | Logical connectives and quantifiers | Lean's notation for propositions ([FIELD §8][F8]) | none | 01 §5; 03 “Type safety”; lean/README “Non-vacuity witnesses”; GUIDE §4; MUTATION “RUE-2490: the statement vocabulary and …”; `Float` |
...
| `Config.init` | `Step` | §6.12's initial configuration: empty store, empty frame, the entry function called with no arguments | standard (FIELD §1: configuration) | 03 “No use-after-drop / no leak …”; lean/README “Non-vacuity witnesses”; GUIDE §2; MUTATION “RUE-2490: the statement vocabulary and …”; `Step` |
...
| `StoreCC` | `Trace.Defs` | Every live cell satisfies `Contents.copyClosed` | helper | lean/README “Non-vacuity witnesses”; MUTATION “RUE-2490: the statement vocabulary and …” |
...
- Everything imports the proofs; Not mutated; Reproduce; Time; Two further passes; What counts as killed; With the proofs off; In RUE-2241's Linux lane; The lint; On macOS; Read the claim; Running Comparator; unsandboxed and says nothing; `3.0:5` (E0483), mechanized; A `@panic` (by design); Accessor calls

...
| diverging; divergence (static); diverging edge | Of an expression: it transfers control away instead of yielding a value to its context | [spec 3.4:1][s3.4] | — | Rue-specific, grounded | 01 §2; 03 “Type safety”; README intro; lean/README “The bridge corpus”; GUIDE §1; BRIDGE-SENSITIVITY “§5 derivation nodes”; `Statics` |
...
| divergence; nontermination | A run that never finishes; for `eval`, out of fuel at every bound | [FIELD §3][F3]: divergence (clock-based), Owens et al. | `eval_diverges_iff` | standard | 01 §2; 03 “Type safety”; README intro; lean/README “Explaining a program”; GUIDE “What the proof needs”; BRIDGE-SENSITIVITY “Never exercised”; `Statics` |

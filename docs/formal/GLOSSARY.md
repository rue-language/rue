...
| fuel | A bound on how much work the interpreter may do; running out gives a timeout | [FIELD §3][F3]: Amin & Rompf | `eval` | standard | 01 §7; 03 intro; lean/README “The bridge corpus”; GUIDE §2; MUTATION “Limits”; `Dynamics` |
...
| panic; panics; `@panic` | A trap raised by the program, or any trap | [spec 1.4:18][s1], [4.13:5c][s4.13] | `PanicKind` | Rue-specific, grounded | 01 §2; 03 intro; README intro; lean/README “The bridge corpus”; GUIDE §1; BRIDGE-SENSITIVITY “Results”; `Float` |
...
| run | A whole evaluation of a program from its initial configuration | [FIELD §6][F6]: run (Leucker & Schallhart) | `run` | standard | 01 §1; 03 intro; README intro; REDTEAM “Targets”; lean/README “The bridge corpus”; GUIDE intro; BRIDGE-SENSITIVITY “Method”; MUTATION “What is mutated”; `Float` |
...
| statement; statements | What a theorem asserts, read apart from its proof | none; FIELD §8: a theorem's type is a `Prop` (Reference §7.4) ([FIELD §8][F8]) | — | ours, pending audit | 01 §2; 03 “Type safety”; README intro; REDTEAM intro; lean/README intro; GUIDE “How to read this guide”; MUTATION “What is mutated”; `Float` |
...
| sharpness counter-example; sharpness counter-examples; sharpness | A statement about a program (or configuration) of which one hypothesis of a theorem fails, every other holds, and the conclusion fails, so the hypothesis is needed; a theorem's sharpness is its having one for every hypothesis | [FIELD §7][F7]: "sharpness counter-example" differs, none (a counter-example proves non-validity, Beer et al. §4.3) | — | ours, pending audit | REDTEAM “Targets”; lean/README “Layers” |

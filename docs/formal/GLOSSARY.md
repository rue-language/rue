...
| expression | A syntactic form that evaluates to a value | [spec 1.4:9][s1] | `Expr` | Rue-specific, grounded | 01 §2; 03 “Type safety”; README “Contents”; lean/README “Generated programs”; GUIDE §1; BRIDGE-SENSITIVITY “Multi-function programs”; `Syntax` |
...
| Term | Meaning | Source | Lean | Class | First use |
|---|---|---|---|---|---|
| class; multiplicity class | Which of the three usage disciplines a type follows: `Copy`, `Affine` or `Linear` | [FIELD §4][F4] (qualifier); "class" differs, partial | `Mult`, `Ty.mult` | ours, pending audit | 01 §2; 03 intro; README “Contents”; lean/README “Generated programs”; GUIDE §1; MUTATION “What is mutated”; CHECKER-PROFILE intro; `Syntax` |
...
| well-typed | Of a program or expression: some typing derivation exists for it | [FIELD §2][F2]: PFPL Thm 6.4 (progress, for well-typed terms) | `HasTy` | standard | 01 §6.1; 03 intro; lean/README “How to read this, with …”; GUIDE §1; MUTATION “Readings the spec pass corrected”; `Float` |
...
| fuel | A bound on how much work the interpreter may do; running out gives a timeout | [FIELD §3][F3]: Amin & Rompf | `eval` | standard | 01 §7; 03 intro; lean/README “The bridge corpus”; GUIDE §2; BRIDGE-SENSITIVITY “Multi-function programs”; MUTATION “What the proofs kill, and …”; CHECKER-PROFILE intro; `Dynamics` |
...
| claim; claim as a whole | Every headline statement together with the definitions they use, as the red team attacks them | none | — | ours, pending audit | 01 §2; 03 intro; README intro; REDTEAM intro; lean/README “Explaining a program”; GUIDE “One program, traced both ways”; MUTATION “The mutants”; `Dynamics` |
...
| L0 syntax; L1 definitions; L2 proofs; L3 tooling; layer | The four layers of the package, each importing only its own or lower ones | none | — | ours, pending audit | 01 §6.13.3; README “Why comptime is elaboration, not …”; REDTEAM intro; lean/README “Deciding whether to believe it”; GUIDE §6; MUTATION “What is mutated”; TOOLING “How it fits this package”; `Float` |
...
| change | One lane's diff, what per-lane review attacks, as opposed to the whole claim | none | — | ours, pending audit | 01 §2; README “Relationship to the prose spec”; REDTEAM intro; lean/README “Explaining a program”; GUIDE “The three trace theorems, one …”; BRIDGE-SENSITIVITY “Observable destructors”; MUTATION intro; CHECKER-PROFILE “Why a rejected program still …”; TOOLING “The workflows”; `Dynamics` |

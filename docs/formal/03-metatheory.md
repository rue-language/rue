...
program every value and panic `eval` answers, §6's `→*` reaches), and
completeness modulo fuel is owed to RUE-2289's part 3. To check any claim yourself:

...
| [daemon-resource-qualification.md](daemon-resource-qualification.md) | RUE-2129's bounded daemon ownership, transport, runtime-reclamation, and release resource qualification record. | historical | ADR-0085 and RUE-2130 carry the living policy and rollout decision |

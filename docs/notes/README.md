...
| [optimizer-prior-art-survey.md](optimizer-prior-art-survey.md) | Structural survey of `crates/rue-cfg/src/opt/` against LLVM and GCC prompted by RUE-1865: where the pass shapes diverge, which divergences cost correctness, capability, speed, or allocations, and which are deliberate and should stay. | current | — |

...
Historical prototype measurements: the timings and section numbers below describe
the measured revisions. The current interface contract and preview limitations
are in [specification section 6.8](../spec/src/06-items/08-interfaces.md).

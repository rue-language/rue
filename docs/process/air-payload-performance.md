...
before integration. The published change is rebased onto RUE-841 at commit
`e679b6745300108fc0ee432a8557b56c65d90633` (tree
`29fa096543c282ea48c3edd2a8aafc82d2a3a75f`). That parent includes RUE-840's
validated CFG interface and RUE-841's typed RIR payload interface. The rebases
only adapted AIR consumers and tests at those typed phase boundaries and did
not change the measured AIR payload representation or profiler. A subsequent
CI hardening fix rejects
...
python3 scripts/air-payload-fingerprint.py \
  --base e679b6745300108fc0ee432a8557b56c65d90633 \

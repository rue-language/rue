...
<!-- grammar-sync(id="6.8:2", production="interface_def", role="appendix") -->
<!-- grammar-sync(id="6.8:2", production="interface_list", role="appendix") -->
<!-- grammar-sync(id="6.8:2", production="interface_ref", role="appendix") -->
<!-- grammar-sync(id="6.8:2", production="interface_member", role="appendix") -->
<!-- grammar-sync(id="6.8:2", production="interface_const", role="appendix") -->
<!-- grammar-sync(id="6.8:2", production="interface_fn", role="appendix") -->
<!-- grammar-sync(id="6.8:2", production="interface_params", role="appendix") -->
<!-- grammar-sync(id="6.8:2", production="conformance_decl", role="appendix") -->
<!-- grammar-sync(id="6.8:2", production="interface_bound", role="appendix") -->

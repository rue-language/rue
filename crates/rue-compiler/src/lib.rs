...
pub use frontend_session::{
    ...
    CanonicalImportGraphOutput, DefinitionQueryRecord, FRONTEND_DIAGNOSTIC_RETENTION_LIMIT,
...
pub use parsed_modules::{
    ...
    ParsedAstPresentationWork, ParsedModulesWork, ParsedProgram,
...
pub struct CompileState {
    /// Immutable canonical program AST view.
    pub ast: CanonicalMergedAst,
...
/// 1. Builds the canonical parsed-module program
/// 2. Validates and assembles canonical definitions and syntax
...
impl CanonicalFrontendArtifacts {
    ...
    pub fn into_compile_state(self) -> CompileState {
        ...
        let ast = CanonicalMergedAst::from_parsed_program(&parsed);
...
///
/// This function is used by canonical batch and one-shot compilation entry points.

...
const EXPECTED_REVISIONED_QUERY_TESTS: &[&str] = &[
    ...
    "anonymous_transfer_markers_invalidate_warmed_type_factory_gates",
    ...
    "transfer_requirements_revalidate_retained_bodies_and_relocate_diagnostics",
    "transferable_pointer_cycles_are_root_order_independent_and_invalidate",

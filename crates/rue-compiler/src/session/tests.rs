...
fn o3_publishes_nested_unrolled_work_for_canonical_slot_loops() {
    ...
    assert_eq!(
        ...
        crate::canonical_semantic::CfgOptimizationWork {
            ...
            peephole_identities_rewired: 6,
            simplify_blocks_scanned: 38,
            ...
            dce_instructions_removed: 123,
            dce_blocks_removed: 28,
            forward_insts_scanned: 189,
            forward_loads_single_write: 0,
            forward_loads_block_local: 7,
            forward_rule1_dominance_pairs_checked: 0,
            forward_dominator_computations: 0,
            cse_insts_scanned: 255,
            cse_duplicates_replaced: 55,
            cse_max_table_entries_sum: 11,
            cse_dominator_computations: 4,

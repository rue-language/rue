...
pub struct CfgOptimizationMetrics {
    ...
    pub licm_use_index_users_visited: usize,
    pub licm_use_index_edges_visited: usize,
    pub licm_use_index_domain_entries_initialized: usize,
...
impl From<crate::canonical_semantic::CfgOptimizationWork> for CfgOptimizationMetrics {
    fn from(work: crate::canonical_semantic::CfgOptimizationWork) -> Self {
        Self {
            ...
            dce_instructions_removed: work.dce_instructions_removed,
            dce_blocks_removed: work.dce_blocks_removed,
            ...
            licm_use_index_users_visited: work.licm_use_index_users_visited,
            licm_use_index_edges_visited: work.licm_use_index_edges_visited,

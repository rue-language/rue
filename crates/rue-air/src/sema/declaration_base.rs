...
pub struct EpochDerivationUnits {
    ...
    /// Type-pool side-table entries shared by refcount instead of copied.
    pub type_side_table_entries_shared: u64,
    /// Parameter-arena parameters read from the base instead of copied.
    pub parameter_entries_shared: u64,
    /// Canonical module and import-site entries shared by refcount instead of
    /// copied.
    pub canonical_import_entries_shared: u64,
...
impl EpochDerivationUnits {
    ...
    pub fn absorb(&mut self, other: Self) {
        ...
        self.type_side_table_entries_shared += other.type_side_table_entries_shared;
        self.parameter_entries_shared += other.parameter_entries_shared;
        self.canonical_import_entries_shared += other.canonical_import_entries_shared;
    ...
    pub fn total_units_shared(&self) -> u64 {
        self.declaration_namespace_entries_shared
            ...
            + self.type_side_table_entries_shared
            + self.parameter_entries_shared
            + self.canonical_import_entries_shared
    }
}
...
impl super::BodySemanticBase<'_> {
    ...
    fn derivation_unit_sizes(&self) -> EpochDerivationUnits {
        ...
        EpochDerivationUnits {
            ...
            type_side_table_entries_shared: self.type_pool.shared_side_table_units() as u64,
            parameter_entries_shared: self.param_arena.total_params() as u64,
            canonical_import_entries_shared: self
                .canonical_imports
                .as_ref()

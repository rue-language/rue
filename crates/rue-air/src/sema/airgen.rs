//! AIR generation from RIR.
//!
//! This module contains the core logic for converting RIR (untyped IR)
//! to AIR (typed IR) during semantic analysis. It includes:
//!
//! - Function analysis (analyze_function, analyze_single_function, etc.)
//! - Instruction analysis (analyze_inst)
//! - Type inference integration
//! - Constant evaluation
//! - Builtin method/function handling

use std::collections::{HashMap, HashSet};

use lasso::Spur;
use rue_builtins::{
    BUILTIN_TYPES, BuiltinParamType, BuiltinReturnType, BuiltinTypeDef, ReceiverMode,
};
use rue_error::{
...
use crate::types::{ArrayTypeDef, ArrayTypeId, EnumId, StructId, Type, parse_array_type_syntax};
...
impl Sema<'_> {
    ...
    pub(crate) fn analyze_single_function(
        &mut self,
    ...
    ///
    /// Returns the analyzed function and any warnings generated during analysis.
    pub(crate) fn analyze_method_function(
        &mut self,
        infer_ctx: &InferenceContext,
        full_name: &str,
        return_type: Spur,
    ...
    ///
    /// Returns the analyzed function and any warnings generated during analysis.
    pub(crate) fn analyze_destructor_function(
        &mut self,
        infer_ctx: &InferenceContext,
        full_name: &str,
        body: InstRef,

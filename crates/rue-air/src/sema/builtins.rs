//! Built-in type injection and helper methods.
//!
//! This module handles the injection of built-in types like String
//! and provides helper methods for working with them.

...
impl<'a> AstGen<'a> {
            ...
            this.rir
                .add_fn_decl_with_return_modes(
                    ...
                    FnDeclFlags {
                        ...
                        returns_inout: requirement.place_return.is_some_and(|mode| mode.is_inout()),
                        ..FnDeclFlags::default()
                    },
                    name,
                    &params,
    ...
    /// further interfaces (spec 6.8:14).
    ...
    fn interfaces_lower_to_interface_shells_with_panic_stub_requirements() {
        let (rir, interner) = gen_rir(
            "pub interface Collection: Sequence + Equatable { \
                 ...
                 fn make(n: i64) -> Self; \
                 fn get(borrow self, i: u64) -> Element; \
             }",
        );
        ...
        let expected = [
            ...
            ("get", true, RirParamMode::Borrow, 1, "Element", false),
        ];

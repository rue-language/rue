...
pub use inst::{
    ...
    RirAnonStructMethodsRange, RirArgMode, RirArrayElemsRange, RirAssocTypesRange,
    ...
    RirFallibleIntrinsic, RirFallibleIntrinsicSet, RirFieldInitsRange, RirInterfaceRefsRange,
